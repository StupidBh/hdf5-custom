    ...
    if (HDF5_FOUND)
      ...
      if (NOT HDF5_static_C_FOUND AND NOT HDF5_shared_C_FOUND)
        ...
        if (HDF5_PROVIDES_SHARED_LIBS)
          target_compile_definitions (hdf5_examples_platform INTERFACE H5_BUILT_AS_DYNAMIC_LIB)
        else ()
          target_compile_definitions (hdf5_examples_platform INTERFACE H5_BUILT_AS_STATIC_LIB)
        endif ()
        ...
        if (HDF5_SHARE_DIR STREQUAL HDF5_BUILD_DIR)
          set (HDF5_LIBRARY_PATH "${HDF5_BUILD_DIR}/bin")
        else ()
          list (GET HDF5_INCLUDE_DIR 0 _hdf5_primary_include_dir)
          get_filename_component (_LIBRARY_PATH "${_hdf5_primary_include_dir}" DIRECTORY)
          set (HDF5_LIBRARY_PATH "${_LIBRARY_PATH}/lib")
          unset (_hdf5_primary_include_dir)
        endif ()
