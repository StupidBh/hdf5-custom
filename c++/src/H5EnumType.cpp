...
namespace H5 {
    ...
    //--------------------------------------------------------------------------
    EnumType::EnumType(const hid_t existing_id) :
    ...
    //--------------------------------------------------------------------------
    EnumType::EnumType(const EnumType& original) :
        DataType(original)
    {
    }
    ...
    //              the enum datatype.
    //--------------------------------------------------------------------------
    EnumType::EnumType(size_t size) :
        DataType(H5T_ENUM, size)
    {
    }
    ...
    ///\exception   H5::DataTypeIException
    //--------------------------------------------------------------------------
    EnumType::EnumType(const DataSet& dataset) :
        DataType()
    {
    ...
    //              -BMR, Dec 2016
    //--------------------------------------------------------------------------
    EnumType::EnumType(const H5Location& loc, const char* dtype_name) :
        DataType()
    {
    ...
    //              -BMR, Dec 2016
    //--------------------------------------------------------------------------
    EnumType::EnumType(const H5Location& loc, const H5std_string& dtype_name) :
        DataType()
    {
    ...
    int EnumType::getNmembers() const
    {
        ...
        if (num_members < 0) {
            throw DataTypeIException("EnumType::getNmembers", "H5Tget_nmembers returns negative number of members");
        }
        return (num_members);
    }
