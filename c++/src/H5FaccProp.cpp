...
namespace H5 {
    ...
    //--------------------------------------------------------------------------
    FileAccPropList::FileAccPropList(const FileAccPropList& original) :
        PropList(original)
    {
    }
    ...
    ///             existing one.
    //--------------------------------------------------------------------------
    FileAccPropList::FileAccPropList(const hid_t plist_id) :
        PropList(plist_id)
    {
    }
    ...
    //--------------------------------------------------------------------------
    void FileAccPropList::setCore(size_t increment, bool backing_store) const
    {
    ...
    ///\exception   H5::PropListIException
    //--------------------------------------------------------------------------
    void FileAccPropList::getCore(size_t& increment, bool& backing_store) const
    {
    ...
    ///\exception   H5::PropListIException
    //--------------------------------------------------------------------------
    void FileAccPropList::setSplit(const FileAccPropList& meta_plist,
                                   const FileAccPropList& raw_plist,
                                   const H5std_string& meta_ext,
                                   const H5std_string& raw_ext) const
    {
    ...
    ///             the HDF5 C Reference Manual.
    //--------------------------------------------------------------------------
    void FileAccPropList::setFileLocking(bool use_file_locking, bool ignore_when_disabled) const
    {
    ...
    ///             the HDF5 C Reference Manual.
    //--------------------------------------------------------------------------
    void FileAccPropList::getFileLocking(bool& use_file_locking, bool& ignore_when_disabled) const
    {
