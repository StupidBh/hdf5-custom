...
namespace H5 {
    ...
    //--------------------------------------------------------------------------
    FileCreatPropList::FileCreatPropList(const FileCreatPropList& original) :
        PropList(original)
    {
    }
    ...
    //--------------------------------------------------------------------------
    FileCreatPropList::FileCreatPropList(const hid_t plist_id) :
        PropList(plist_id)
    {
    }
    ...
    //--------------------------------------------------------------------------
    void FileCreatPropList::setFileSpaceStrategy(H5F_fspace_strategy_t strategy, bool persist, hsize_t threshold) const
    {
        herr_t ret_value = H5Pset_file_space_strategy(id, strategy, persist, threshold);
        if (ret_value < 0) {
            throw PropListIException("FileCreatPropList::setFileSpaceStrategy", "H5Pset_file_space_strategy failed");
        }
    }
    ...
    ///\exception   H5::PropListIException
    //--------------------------------------------------------------------------
    void FileCreatPropList::getFileSpaceStrategy(H5F_fspace_strategy_t& strategy, bool& persist, hsize_t& threshold) const
    {
        herr_t ret_value = H5Pget_file_space_strategy(id, &strategy, &persist, &threshold);
        if (ret_value < 0) {
            throw PropListIException("FileCreatPropList::getFileSpaceStrategy", "H5Pget_file_space_strategy failed");
        }
    }
    ...
    void FileCreatPropList::setFileSpacePagesize(hsize_t fsp_psize) const
    {
        ...
        if (ret_value < 0) {
            throw PropListIException("FileCreatPropList::setFileSpacePagesize", "H5Pset_file_space_page_size failed");
        }
    }
    ...
    hsize_t FileCreatPropList::getFileSpacePagesize() const
    {
        ...
        if (ret_value < 0) {
            throw PropListIException("FileCreatPropList::getFileSpacePagesize", "H5Pget_file_space_page_size failed");
        }
        return (fsp_psize);
    }
