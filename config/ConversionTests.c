...
int HDF_NO_UBSAN main(void)
{
    ...
    if (sizeof(long double) == 16 && sizeof(long) == 8) {
         ...
         */
        memcpy(s, &ld, 16);
        if (s[0] == 0x43 && s[1] == 0x51 && s[2] == 0xcc && s[3] == 0xf3 && s[4] == 0x85 && s[5] == 0xeb && s[6] == 0xc8 && s[7] == 0xa0 && s[8] == 0xbf &&
            s[9] == 0xcc && s[10] == 0x2a && s[11] == 0x3c) {
             ...
             */
            if (s2[0] == 0x00 && s2[1] == 0x47 && s2[2] == 0x33 && s2[3] == 0xce && s2[4] == 0x17 && s2[5] == 0xaf && s2[6] == 0x22 && s2[7] == 0x7f) {
                ret = 0;
            }
...
int HDF_NO_UBSAN main(void)
{
    ...
    if (sizeof(long double) == 16) {
        ...
        if (s[0] == 0x3f && s[1] == 0xf0 && s[2] == 0x00 && s[3] == 0x00 && s[4] == 0x00 && s[5] == 0x00 && s[6] == 0x00 && s[7] == 0x00) {
            flag = 1;
        }
    }
    ...
    if (flag == 1 && sizeof(long) == 8) {
         ...
         */
        if (s[0] == 0x43 && s[1] == 0x50 && s[2] == 0x00 && s[3] == 0x00 && s[4] == 0x00 && s[5] == 0x00 && s[6] == 0x00 && s[7] == 0x00 && s[8] == 0xbf &&
            s[9] == 0xf0 && s[10] == 0x00 && s[11] == 0x00 && s[12] == 0x00 && s[13] == 0x00 && s[14] == 0x00 && s[15] == 0x00) {
            ret = 0;
        }
    }
    ...
    if (flag == 1 && sizeof(unsigned long) == 8) {
         ...
         * skip the test until we can figure out how they do it.
         */
        if (s[0] == 0x43 && s[1] == 0xf0 && s[2] == 0x00 && s[3] == 0x00 && s[4] == 0x00 && s[5] == 0x00 && s[6] == 0x00 && s[7] == 0x00 && s[8] == 0xbf &&
            s[9] == 0xf0 && s[10] == 0x00 && s[11] == 0x00 && s[12] == 0x00 && s[13] == 0x00 && s[14] == 0x00 && s[15] == 0x00) {
            ret = 0;
        }
    }
...
int HDF_NO_UBSAN main(void)
{
    ...
    if (flag == 1 && sizeof(long long) == 8) {
        ...
        if (s[0] != 0x43 || s[1] != 0x7f || s[2] != 0xff || s[3] != 0xff || s[4] != 0xff || s[5] != 0xff || s[6] != 0xff || s[7] != 0xff || s[8] != 0xf0 ||
            s[9] != 0x00 || s[10] != 0x00 || s[11] != 0x00) {
            ret = 1;
        }
    }
