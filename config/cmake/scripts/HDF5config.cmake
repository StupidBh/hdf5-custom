...
### BUILD_GENERATOR required [Unix, VS202664]                                             ###
### ctest -S HDF5config.cmake,BUILD_GENERATOR=VS202664 -C Release -VV -O hdf5.log         ###
#############################################################################################
...
#            Unix      * Unix Makefiles
#            VS202664  * Visual Studio 18 2026, x64
#
...
if (NOT DEFINED BUILD_GENERATOR)
  message (FATAL_ERROR "BUILD_GENERATOR must be defined - Unix or VS202664")
endif ()
...
if (NOT DEFINED HPC)
  if (WIN32)
    if (NOT BUILD_GENERATOR STREQUAL "VS202664")
      message (FATAL_ERROR "BUILD_GENERATOR must be VS202664 on Windows")
    endif ()
  ...
  elseif (CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
    if (NOT BUILD_GENERATOR STREQUAL "Unix")
      message (FATAL_ERROR "BUILD_GENERATOR must be Unix on Linux")
    endif ()
    if (DEFINED NINJA)
    ...
    message (FATAL_ERROR "The CTest dashboard supports only Windows x64 with MSVC or Linux x86_64 with GCC/G++")
  endif ()
else ()
