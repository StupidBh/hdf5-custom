    ...
    if (NOT H5${EXTNAME}_HDF5_HEADER)
      ...
      if (HDF5_FOUND)
        if (NOT HDF5_static_C_FOUND AND NOT HDF5_shared_C_FOUND)
          ...
          set (_hdf5_support_target "hdf5_${EXTNAME}_usage_requirements")
          if (NOT TARGET ${_hdf5_support_target})
            add_library (${_hdf5_support_target} INTERFACE IMPORTED GLOBAL)
          endif ()
          if (HDF5_PROVIDES_SHARED_LIBS)
            target_compile_definitions (${_hdf5_support_target} INTERFACE H5_BUILT_AS_DYNAMIC_LIB)
          else ()
            target_compile_definitions (${_hdf5_support_target} INTERFACE H5_BUILT_AS_STATIC_LIB)
          endif ()
          list (APPEND H5${EXTNAME}_HDF5_LINK_LIBS ${_hdf5_support_target})
          unset (_hdf5_support_target)
