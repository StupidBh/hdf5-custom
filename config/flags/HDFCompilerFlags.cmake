...
if (MSVC)
  ...
  list (APPEND HDF5_PLATFORM_EXECUTABLE_LINK_OPTIONS "-stack:10000000")
endif ()
...
if (HDF5_ENABLE_ASSERTS STREQUAL "YES")
  set (HDF5_ASSERT_COMPILE_OPTION "-UNDEBUG")
elseif (HDF5_ENABLE_ASSERTS STREQUAL "NO")
  set (HDF5_ASSERT_COMPILE_OPTION "-DNDEBUG")
endif ()
