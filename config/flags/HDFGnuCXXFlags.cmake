...
if (CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 4.8)
  ...
  ADD_H5_FLAGS (HDF5_CMAKE_CXX_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-general")
  ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-error-general")
endif ()
...
if (HDF5_ENABLE_DEV_WARNINGS)
  message (STATUS "....HDF5 CXX developer group warnings are enabled")
    ...
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-general")
else ()
    # Use the C warnings as CXX warnings are the same
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-general")
endif ()
  ...
  if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 5.0 AND CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 4.8)
    # Use the C warnings as CXX warnings are the same
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/4.8-4.last")
  endif ()

  # Append more extra warning flags that only gcc 4.8+ knows about
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 4.8)
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-4.8")
    if (HDF5_ENABLE_DEV_WARNINGS)
      # Use the C warnings as CXX warnings are the same
      ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-developer-4.8")
    else ()
      ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-cxx-developer-4.8")
    endif ()
  endif ()
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 4.9)
    # Use the C warnings as CXX warnings are the same
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-4.9")
  endif ()

  # Append more extra warning flags that only gcc 5.1+ knows about
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 5.0)
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-5")
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-error-5")
  endif ()

  # Append more extra warning flags that only gcc 6.x+ knows about
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 6.0)
    # Use the C warnings as CXX warnings are the same
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/6")
  endif ()
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 7.0)
    ...
    if (HDF5_ENABLE_DEV_WARNINGS)
    # Use the C warnings as CXX warnings are the same
      ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-7")
    #else ()
    #  ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-7")
    endif ()
  endif ()
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 8.0)
    # Use the C warnings as CXX warnings are the same
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/8")
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/error-8")
    if (HDF5_ENABLE_DEV_WARNINGS)
      # Use the C warnings as CXX warnings are the same
      ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-8")
    else ()
      ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-8")
    endif ()
  endif ()
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 9.0)
    # Use the C warnings as CXX warnings are the same
    ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/cxx-9")
  endif ()
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 9.3)
    ...
    # ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/9.3")
  endif ()
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 10.0)
    if (HDF5_ENABLE_DEV_WARNINGS)
      # Use the C warnings as CXX warnings are the same
      ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-10")
    #else ()
    #  ADD_H5_FLAGS (HDF5_CMAKE_CXX_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-10")
    endif ()
  endif ()
