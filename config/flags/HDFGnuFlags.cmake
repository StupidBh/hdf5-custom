...
if (HDF5_ENABLE_DEV_WARNINGS)
  ...
  if (CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 4.8)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-general")
  endif ()
  ...
  if (CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 4.8)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-general")
  endif ()
endif ()
  ...
  if (CMAKE_C_COMPILER_VERSION VERSION_LESS 5.0 AND CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 4.8)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/4.8-4.last")
  endif ()

  # Append more extra warning flags that only gcc 4.8+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 4.8)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/4.8")
    if (HDF5_ENABLE_DEV_WARNINGS)
      ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-4.8")
    else ()
      ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-4.8")
    endif ()
  endif ()

  # Append more extra warning flags that only gcc 4.9+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 4.9)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/4.9")
  endif ()

  # Append more extra warning flags that only gcc 5.x+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 5.0)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/5")
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/error-5")
  endif ()

  # Append more extra warning flags that only gcc 6.x+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 6.0)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/6")
  endif ()

  # Append more extra warning flags that only gcc 7.x+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 7.0)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/7")
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/error-7")
    if (HDF5_ENABLE_DEV_WARNINGS)
      ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-7")
    #else ()
    #  ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-7")
    endif ()
  endif ()

  # Append more extra warning flags that only gcc 8.x+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 8.0)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/8")
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/error-8")
    if (HDF5_ENABLE_DEV_WARNINGS)
      ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-8")
    else ()
      ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-8")
    endif ()
  endif ()

  # Append more extra warning flags that only gcc 9.x+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 9.0)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/9")
  endif ()

  # Append more extra warning flags that only gcc 9.3+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 9.3)
    ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/9.3")
  endif ()

  # Append more extra warning flags that only gcc 10.x+ knows about
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 10.0)
    if (HDF5_ENABLE_DEV_WARNINGS)
      ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-10")
    #else ()
    #  ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-10")
    endif ()
  endif ()
  ...
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 12.0)
    if (HDF5_ENABLE_DEV_WARNINGS)
      ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/developer-12")
    #else ()
    #  ADD_H5_FLAGS (HDF5_CMAKE_C_OPTIONAL_WARNING_FLAGS "${HDF_CONFIG_DIR}/gnu-warnings/no-developer-12")
    endif ()
  endif ()
