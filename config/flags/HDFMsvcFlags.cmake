...
if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 19.28)
  list (APPEND HDF5_PLATFORM_COMPILE_OPTIONS "$<$<COMPILE_LANGUAGE:C>:-wd5105>")
  list (APPEND HDF5_PLATFORM_EXECUTABLE_LINK_OPTIONS "$<$<LINK_LANGUAGE:C>:-wd5105>")
  string (APPEND HDF5_REPORTED_C_FLAGS_SUFFIX " -wd5105")
endif ()
