...
if(HDF5_USE_SANITIZER)
  ...
  if(CMAKE_C_COMPILER_ID MATCHES "IntelLLVM" OR CMAKE_C_COMPILER_ID MATCHES "[Cc]lang")
    ...
    if(UNIX)
      hdf5_append_sanitizer_compile_options("-fno-omit-frame-pointer")
      message(STATUS "Building with sanitize, base flags=${CMAKE_C_FLAGS}${HDF5_REPORTED_C_FLAGS_SUFFIX}")

      if(uppercase_CMAKE_BUILD_TYPE STREQUAL "DEBUG")
        hdf5_append_sanitizer_compile_options("-O1")
      endif()
      ...
      if(SANITIZER_SELECTED_COMPATIBLE)
        ...
        separate_arguments(SANITIZER_SELECTED_OPTIONS UNIX_COMMAND "${SANITIZER_SELECTED_FLAGS}")
        hdf5_append_sanitizer_compile_options(${SANITIZER_SELECTED_OPTIONS})
      else()
