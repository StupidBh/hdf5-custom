...
fail_file:;
    ...
    //! <!-- [read] -->
    {
        ...
        case H5G_STORAGE_TYPE_COMPACT     : printf("Compact storage\n"); break;
        case H5G_STORAGE_TYPE_DENSE       : printf("Compact storage\n"); break;
        case H5G_STORAGE_TYPE_SYMBOL_TABLE: printf("Symbol table\n"); break;
        default                           : printf("UFO\n"); break;
        }
