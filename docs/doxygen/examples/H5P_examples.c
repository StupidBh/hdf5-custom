...
fail_dcpl:;
    ...
    //! <!-- [create_class] -->
    {
        ...
        if ((plist_cls = H5Pcreate_class(H5P_ROOT, "int & double", NULL, NULL, NULL, NULL, NULL, NULL)) == H5I_INVALID_HID) {
            ret_val = EXIT_FAILURE;
            goto fail_cls;
        }
...
fail_cls:;
    ...
    //! <!-- [read_class] -->
    {
        ...
        if ((plist_cls = H5Pcreate_class(H5P_ROOT, "ud_plist", NULL, NULL, NULL, NULL, NULL, NULL)) == H5I_INVALID_HID) {
            ret_val = EXIT_FAILURE;
            goto fail_cls;
        }
        if ((plist = H5Pcreate(plist_cls)) < 0) {
