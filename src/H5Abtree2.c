...
static herr_t H5A__dense_btree2_corder_debug(FILE* stream, int indent, int fwidth, const void* record, const void* _udata);
...
static herr_t H5A__dense_btree2_name_debug(FILE* stream, int indent, int fwidth, const void* record, const void* _udata);
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_fh_name_cmp(const void* obj, size_t obj_len, void* _udata)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_name_compare(const void* _bt2_udata, const void* _bt2_rec, int* result)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_name_encode(uint8_t* raw, const void* _nrecord, void H5_ATTR_UNUSED* ctx)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_name_decode(const uint8_t* raw, void* _nrecord, void H5_ATTR_UNUSED* ctx)
{
    H5A_dense_bt2_name_rec_t* nrecord = (H5A_dense_bt2_name_rec_t*)_nrecord;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_name_debug(FILE* stream, int indent, int fwidth, const void* _nrecord, const void H5_ATTR_UNUSED* _udata)
{
    const H5A_dense_bt2_name_rec_t* nrecord = (const H5A_dense_bt2_name_rec_t*)_nrecord;
    ...
    fprintf(stream,
            "%*s%-*s {%016" PRIx64 ", %02" PRIx8 ", %u, %08" PRIx32 "}\n",
            indent,
            "",
            fwidth,
            "Record:",
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_corder_store(void* _nrecord, const void* _udata)
{
    const H5A_bt2_ud_ins_t* udata = (const H5A_bt2_ud_ins_t*)_udata;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_corder_compare(const void* _bt2_udata, const void* _bt2_rec, int* result)
{
    const H5A_bt2_ud_common_t* bt2_udata = (const H5A_bt2_ud_common_t*)_bt2_udata;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_corder_encode(uint8_t* raw, const void* _nrecord, void H5_ATTR_UNUSED* ctx)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_corder_decode(const uint8_t* raw, void* _nrecord, void H5_ATTR_UNUSED* ctx)
{
    H5A_dense_bt2_corder_rec_t* nrecord = (H5A_dense_bt2_corder_rec_t*)_nrecord;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5A__dense_btree2_corder_debug(FILE* stream, int indent, int fwidth, const void* _nrecord, const void H5_ATTR_UNUSED* _udata)
{
    const H5A_dense_bt2_corder_rec_t* nrecord = (const H5A_dense_bt2_corder_rec_t*)_nrecord;

    FUNC_ENTER_PACKAGE_NOERR

    fprintf(stream, "%*s%-*s {%016" PRIx64 ", %02" PRIx8 ", %u}\n", indent, "", fwidth, "Record:", nrecord->id.val, nrecord->flags, (unsigned)nrecord->corder);
