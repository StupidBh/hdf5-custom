 ...
 */
    ...
    #define H5B2_TREE_POINTER_SIZE(sizeof_addr, sizeof_size) ((sizeof_addr) + H5B2_SIZEOF_RECORDS_PER_NODE + (sizeof_size))
    ...
    #define H5B2_HEADER_SIZE(sizeof_addr, sizeof_size)                                                             \
        (                                                   /* General metadata fields */                          \
         H5B2_METADATA_PREFIX_SIZE                          /* Header specific fields */                           \
    ...
    #define H5B2_INT_PREFIX_SIZE                                                              \
        (                                                       /* General metadata fields */ \
         H5B2_METADATA_PREFIX_SIZE /* Header specific fields */ /* <none> */                  \
        )
...
H5_DLL herr_t H5B2__update_flush_depend(H5B2_hdr_t* hdr, unsigned depth, H5B2_node_ptr_t* node_ptr, void* old_parent, void* new_parent);
...
H5_DLL H5B2_leaf_t* H5B2__protect_leaf(H5B2_hdr_t* hdr, void* parent, H5B2_node_ptr_t* node_ptr, bool shadow, unsigned flags);
...
H5_DLL H5B2_internal_t* H5B2__protect_internal(H5B2_hdr_t* hdr, void* parent, H5B2_node_ptr_t* node_ptr, uint16_t depth, bool shadow, unsigned flags);
...
H5_DLL herr_t H5B2__iterate_node(H5B2_hdr_t* hdr, uint16_t depth, H5B2_node_ptr_t* curr_node, void* parent, H5B2_operator_t op, void* op_data);
H5_DLL herr_t H5B2__node_size(H5B2_hdr_t* hdr, uint16_t depth, H5B2_node_ptr_t* curr_node, void* parent, hsize_t* op_data);
...
H5_DLL herr_t H5B2__remove_internal(H5B2_hdr_t* hdr,
                                    ...
                                    void* op_data);
H5_DLL herr_t
    H5B2__remove_leaf(H5B2_hdr_t* hdr, H5B2_node_ptr_t* curr_node_ptr, H5B2_nodepos_t curr_pos, void* parent, void* udata, H5B2_remove_t op, void* op_data);
H5_DLL herr_t H5B2__remove_internal_by_idx(H5B2_hdr_t* hdr,
                                           ...
                                           void* op_data);
H5_DLL herr_t
    H5B2__remove_leaf_by_idx(H5B2_hdr_t* hdr, H5B2_node_ptr_t* curr_node_ptr, H5B2_nodepos_t curr_pos, void* parent, unsigned idx, H5B2_remove_t op, void* op_data);

/* Routines for deleting nodes */
H5_DLL herr_t H5B2__delete_node(H5B2_hdr_t* hdr, uint16_t depth, H5B2_node_ptr_t* curr_node, void* parent, H5B2_remove_t op, void* op_data);
...
H5_DLL herr_t H5B2__int_debug(H5F_t* f,
                              ...
                              haddr_t obj_addr);
H5_DLL herr_t
    H5B2__leaf_debug(H5F_t* f, haddr_t addr, FILE* stream, int indent, int fwidth, const H5B2_class_t* type, haddr_t hdr_addr, unsigned nrec, haddr_t obj_addr);
