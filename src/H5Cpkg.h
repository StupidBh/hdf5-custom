 ...
 ****************************************************************************/
        ...
        #define H5C__GEN_DLL_PRE_REMOVE_SC(entry_ptr, list_next, list_prev, head_ptr, tail_ptr, len, list_size, fail_val)                                          \
            do {                                                                                                                                                   \
                if ((head_ptr) == NULL || (tail_ptr) == NULL || (entry_ptr) == NULL || (len) <= 0 || (list_size) < (entry_ptr)->size ||                            \
                    ((entry_ptr)->list_prev == NULL && (head_ptr) != (entry_ptr)) || ((entry_ptr)->list_next == NULL && (tail_ptr) != (entry_ptr)) ||              \
                    ((len) == 1 && !((head_ptr) == (entry_ptr) && (tail_ptr) == (entry_ptr) && (entry_ptr)->list_next == NULL && (entry_ptr)->list_prev == NULL && \
        ...
        #define H5C__GEN_DLL_PRE_INSERT_SC(entry_ptr, list_next, list_prev, head_ptr, tail_ptr, len, list_size, fail_val)                       \
            if ((entry_ptr) == NULL || (entry_ptr)->list_next != NULL || (entry_ptr)->list_prev != NULL ||                                      \
                ...
                ((len) == 1 && ((head_ptr) != (tail_ptr) || (head_ptr) == NULL || (head_ptr)->size != (list_size))) ||                          \
                ((len) >= 1 && ((head_ptr) == NULL || (head_ptr)->list_prev != NULL || (tail_ptr) == NULL || (tail_ptr)->list_next != NULL))) { \
        ...
        #define H5C__GEN_DLL_PRE_SIZE_UPDATE_SC(dll_len, dll_size, old_size, new_size, fail_val)                      \
            if ((dll_len) <= 0 || (dll_size) <= 0 || (old_size) <= 0 || (old_size) > (dll_size) || (new_size) <= 0 || \
 ...
 ***********************************************************************/
    ...
    #define H5C__POST_HT_SHIFT_TO_FRONT_SC_CMP(cache_ptr, entry_ptr, k) ((cache_ptr) == NULL || (cache_ptr)->index[k] != (entry_ptr) || (entry_ptr)->ht_prev != NULL)
    #define H5C__PRE_HT_SEARCH_SC_CMP(cache_ptr, entry_addr)                                                                                                  \
        ((cache_ptr) == NULL || (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) || !H5_addr_defined(entry_addr) || \
         H5C__HASH_FCN(entry_addr) < 0 || H5C__HASH_FCN(entry_addr) >= H5C__HASH_TABLE_LEN)
    #define H5C__POST_SUC_HT_SEARCH_SC_CMP(cache_ptr, entry_ptr, k)                                                                                               \
        ((cache_ptr) == NULL || (cache_ptr)->index_len < 1 || (entry_ptr) == NULL || (cache_ptr)->index_size < (entry_ptr)->size ||                               \
         (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) || (entry_ptr)->size <= 0 || (cache_ptr)->index[k] == NULL || \
         ((cache_ptr)->index[k] != (entry_ptr) && (entry_ptr)->ht_prev == NULL) || ((cache_ptr)->index[k] == (entry_ptr) && (entry_ptr)->ht_prev != NULL) ||      \
        ...
        #define H5C__PRE_HT_INSERT_SC(cache_ptr, entry_ptr, fail_val)                                                                  \
            if ((cache_ptr) == NULL || (entry_ptr) == NULL || !H5_addr_defined((entry_ptr)->addr) || (entry_ptr)->ht_next != NULL ||   \
                (entry_ptr)->ht_prev != NULL || (entry_ptr)->size <= 0 || H5C__HASH_FCN((entry_ptr)->addr) < 0 ||                      \
                ...
                (cache_ptr)->index_size < (cache_ptr)->clean_index_size || (cache_ptr)->index_size < (cache_ptr)->dirty_index_size ||  \
                ...
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] !=                                                                     \
                    ((cache_ptr)->clean_index_ring_size[(entry_ptr)->ring] + (cache_ptr)->dirty_index_ring_size[(entry_ptr)->ring]) || \
        ...
        #define H5C__POST_HT_INSERT_SC(cache_ptr, entry_ptr, fail_val)                                                                            \
            if ((cache_ptr) == NULL || (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) ||              \
                (cache_ptr)->index_size < (cache_ptr)->clean_index_size || (cache_ptr)->index_size < (cache_ptr)->dirty_index_size ||             \
                (cache_ptr)->index_ring_len[(entry_ptr)->ring] == 0 || (cache_ptr)->index_ring_len[(entry_ptr)->ring] > (cache_ptr)->index_len || \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] > (cache_ptr)->index_size ||                                                      \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] !=                                                                                \
                    ((cache_ptr)->clean_index_ring_size[(entry_ptr)->ring] + (cache_ptr)->dirty_index_ring_size[(entry_ptr)->ring]) ||            \
                (cache_ptr)->index_len != (cache_ptr)->il_len || (cache_ptr)->index_size != (cache_ptr)->il_size) {                               \
        ...
        #define H5C__PRE_HT_REMOVE_SC(cache_ptr, entry_ptr, fail_val)                                                                                             \
            if ((cache_ptr) == NULL || (cache_ptr)->index_len < 1 || (entry_ptr) == NULL || (cache_ptr)->index_size < (entry_ptr)->size ||                        \
                !H5_addr_defined((entry_ptr)->addr) || (entry_ptr)->size <= 0 || H5C__HASH_FCN((entry_ptr)->addr) < 0 ||                                          \
                H5C__HASH_FCN((entry_ptr)->addr) >= H5C__HASH_TABLE_LEN || (cache_ptr)->index[H5C__HASH_FCN((entry_ptr)->addr)] == NULL ||                        \
                ((cache_ptr)->index[H5C__HASH_FCN((entry_ptr)->addr)] != (entry_ptr) && (entry_ptr)->ht_prev == NULL) ||                                          \
                ((cache_ptr)->index[H5C__HASH_FCN((entry_ptr)->addr)] == (entry_ptr) && (entry_ptr)->ht_prev != NULL) ||                                          \
                (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) ||                                                     \
                (cache_ptr)->index_size < (cache_ptr)->clean_index_size || (cache_ptr)->index_size < (cache_ptr)->dirty_index_size ||                             \
                (entry_ptr)->ring <= H5C_RING_UNDEFINED || (entry_ptr)->ring >= H5C_RING_NTYPES || (cache_ptr)->index_ring_len[(entry_ptr)->ring] <= 0 ||         \
                (cache_ptr)->index_ring_len[(entry_ptr)->ring] > (cache_ptr)->index_len || (cache_ptr)->index_ring_size[(entry_ptr)->ring] < (entry_ptr)->size || \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] > (cache_ptr)->index_size ||                                                                      \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] !=                                                                                                \
                    ((cache_ptr)->clean_index_ring_size[(entry_ptr)->ring] + (cache_ptr)->dirty_index_ring_size[(entry_ptr)->ring]) ||                            \
                (cache_ptr)->index_len != (cache_ptr)->il_len || (cache_ptr)->index_size != (cache_ptr)->il_size) {                                               \
        ...
        #define H5C__POST_HT_REMOVE_SC(cache_ptr, entry_ptr, fail_val)                                                                                         \
            if ((cache_ptr) == NULL || (entry_ptr) == NULL || !H5_addr_defined((entry_ptr)->addr) || (entry_ptr)->size <= 0 || (entry_ptr)->ht_next != NULL || \
                (entry_ptr)->ht_prev != NULL || (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) ||                  \
                (cache_ptr)->index_size < (cache_ptr)->clean_index_size || (cache_ptr)->index_size < (cache_ptr)->dirty_index_size ||                          \
                (cache_ptr)->index_ring_len[(entry_ptr)->ring] > (cache_ptr)->index_len ||                                                                     \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] > (cache_ptr)->index_size ||                                                                   \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] !=                                                                                             \
        ...
        #define H5C__PRE_HT_ENTRY_SIZE_CHANGE_SC(cache_ptr, old_size, new_size, entry_ptr, was_clean, fail_val)                                                  \
            if ((cache_ptr) == NULL || (cache_ptr)->index_len <= 0 || (cache_ptr)->index_size <= 0 || (new_size) <= 0 || (old_size) > (cache_ptr)->index_size || \
                ((cache_ptr)->index_len == 1 && (cache_ptr)->index_size != (old_size)) ||                                                                        \
                (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) ||                                                    \
                (cache_ptr)->index_size < (cache_ptr)->clean_index_size || (cache_ptr)->index_size < (cache_ptr)->dirty_index_size ||                            \
                ((!(was_clean) || (cache_ptr)->clean_index_size < (old_size)) && ((was_clean) || (cache_ptr)->dirty_index_size < (old_size))) ||                 \
                (entry_ptr) == NULL || (entry_ptr)->ring <= H5C_RING_UNDEFINED || (entry_ptr)->ring >= H5C_RING_NTYPES ||                                        \
                (cache_ptr)->index_ring_len[(entry_ptr)->ring] <= 0 || (cache_ptr)->index_ring_len[(entry_ptr)->ring] > (cache_ptr)->index_len ||                \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] > (cache_ptr)->index_size ||                                                                     \
                (cache_ptr)->index_ring_size[(entry_ptr)->ring] !=                                                                                               \
                    ((cache_ptr)->clean_index_ring_size[(entry_ptr)->ring] + (cache_ptr)->dirty_index_ring_size[(entry_ptr)->ring]) ||                           \
        ...
        #define H5C__POST_HT_ENTRY_SIZE_CHANGE_SC(cache_ptr, old_size, new_size, entry_ptr, fail_val)                                         \
            if ((cache_ptr) == NULL || (cache_ptr)->index_len <= 0 || (cache_ptr)->index_size <= 0 || (new_size) > (cache_ptr)->index_size || \
                (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) ||                                 \
                (cache_ptr)->index_size < (cache_ptr)->clean_index_size || (cache_ptr)->index_size < (cache_ptr)->dirty_index_size ||         \
        ...
        #define H5C__PRE_HT_UPDATE_FOR_ENTRY_CLEAN_SC(cache_ptr, entry_ptr, fail_val)                                                                     \
            if ((cache_ptr) == NULL || (cache_ptr)->index_len <= 0 || (entry_ptr) == NULL || (entry_ptr)->is_dirty != false ||                            \
                (cache_ptr)->index_size < (entry_ptr)->size || (cache_ptr)->dirty_index_size < (entry_ptr)->size ||                                       \
                (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) ||                                             \
                (cache_ptr)->index_size < ((cache_ptr)->clean_index_size) || (cache_ptr)->index_size < ((cache_ptr)->dirty_index_size) ||                 \
                (entry_ptr)->ring <= H5C_RING_UNDEFINED || (entry_ptr)->ring >= H5C_RING_NTYPES || (cache_ptr)->index_ring_len[(entry_ptr)->ring] <= 0 || \
                (cache_ptr)->index_ring_len[(entry_ptr)->ring] > (cache_ptr)->index_len ||                                                                \
        ...
        #define H5C__PRE_HT_UPDATE_FOR_ENTRY_DIRTY_SC(cache_ptr, entry_ptr, fail_val)                                                                     \
            if ((cache_ptr) == NULL || (cache_ptr)->index_len <= 0 || (entry_ptr) == NULL || (entry_ptr)->is_dirty != true ||                             \
                (cache_ptr)->index_size < (entry_ptr)->size || (cache_ptr)->clean_index_size < (entry_ptr)->size ||                                       \
                (cache_ptr)->index_size != ((cache_ptr)->clean_index_size + (cache_ptr)->dirty_index_size) ||                                             \
                (cache_ptr)->index_size < (cache_ptr)->clean_index_size || (cache_ptr)->index_size < (cache_ptr)->dirty_index_size ||                     \
                (entry_ptr)->ring <= H5C_RING_UNDEFINED || (entry_ptr)->ring >= H5C_RING_NTYPES || (cache_ptr)->index_ring_len[(entry_ptr)->ring] <= 0 || \
                (cache_ptr)->index_ring_len[(entry_ptr)->ring] > (cache_ptr)->index_len ||                                                                \
    ...
    #define H5C__INSERT_IN_INDEX(cache_ptr, entry_ptr, fail_val)                                                                              \
        do {                                                                                                                                  \
            ...
            H5C__IL_DLL_APPEND((entry_ptr), (cache_ptr)->il_head, (cache_ptr)->il_tail, (cache_ptr)->il_len, (cache_ptr)->il_size, fail_val); \
    ...
    #define H5C__DELETE_FROM_INDEX(cache_ptr, entry_ptr, fail_val)                                                                            \
        do {                                                                                                                                  \
            ...
            H5C__IL_DLL_REMOVE((entry_ptr), (cache_ptr)->il_head, (cache_ptr)->il_tail, (cache_ptr)->il_len, (cache_ptr)->il_size, fail_val); \
    ...
    #define H5C__UPDATE_INDEX_FOR_SIZE_CHANGE(cache_ptr, old_size, new_size, entry_ptr, was_clean, fail_val)                \
        do {                                                                                                                \
            ...
            H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->il_len, (cache_ptr)->il_size, (old_size), (new_size), (fail_val)); \
 ...
 **************************************************************************/
        ...
        #define H5C__UPDATE_RP_FOR_SIZE_CHANGE_CD_LRU(cache_ptr, entry_ptr, new_size, fail_val)                                                         \
            do {                                                                                                                                        \
                 ...
                 */                                                                                                                                     \
                if ((entry_ptr)->is_dirty) {                                                                                                            \
                    H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->dLRU_list_len, (cache_ptr)->dLRU_list_size, (entry_ptr)->size, (new_size), (fail_val)) \
                }                                                                                                                                       \
                else {                                                                                                                                  \
                    H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->cLRU_list_len, (cache_ptr)->cLRU_list_size, (entry_ptr)->size, (new_size), (fail_val)) \
                }                                                                                                                                       \
        ...
        #define H5C__UPDATE_RP_FOR_SIZE_CHANGE_COLL(cache_ptr, entry_ptr, new_size, fail_val)                                                            \
            do {                                                                                                                                         \
                if ((entry_ptr)->coll_access) {                                                                                                          \
                    H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->coll_list_len, (cache_ptr)->coll_list_size, (entry_ptr)->size, (new_size), (fail_val)); \
                }                                                                                                                                        \
    ...
    #define H5C__UPDATE_RP_FOR_SIZE_CHANGE(cache_ptr, entry_ptr, new_size, fail_val)                                                              \
        do {                                                                                                                                      \
            ...
            H5C__UPDATE_RP_FOR_SIZE_CHANGE_COLL(cache_ptr, entry_ptr, new_size, fail_val);                                                        \
                                                                                                                                                  \
            if ((entry_ptr)->is_pinned) {                                                                                                         \
                H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->pel_len, (cache_ptr)->pel_size, (entry_ptr)->size, (new_size), (fail_val))           \
            }                                                                                                                                     \
            else {                                                                                                                                \
                /* Update the size of the LRU list */                                                                                             \
                H5C__DLL_UPDATE_FOR_SIZE_CHANGE((cache_ptr)->LRU_list_len, (cache_ptr)->LRU_list_size, (entry_ptr)->size, (new_size), (fail_val)) \
                                                                                                                                                  \
                /* Maintain the clean & dirty LRU lists, if enabled */                                                                            \
     ...
     */
        ...
        #define H5C__INSERT_IN_COLL_LIST(cache_ptr, entry_ptr, fail_val) \
            do {                                                         \
                ...
                H5C__COLL_DLL_PREPEND((entry_ptr),                       \
                                      (cache_ptr)->coll_head_ptr,        \
     ...
     */
        ...
        #define H5C__REMOVE_FROM_COLL_LIST(cache_ptr, entry_ptr, fail_val) \
            do {                                                           \
                ...
                H5C__COLL_DLL_REMOVE((entry_ptr),                          \
                                     (cache_ptr)->coll_head_ptr,           \
                                     (cache_ptr)->coll_tail_ptr,           \
                                     (cache_ptr)->coll_list_len,           \
                                     (cache_ptr)->coll_list_size,          \
...
H5_DLL herr_t H5C__iter_tagged_entries(H5C_t* cache, haddr_t tag, bool match_global, H5C_tag_iter_cb_t cb, void* cb_ctx);
