 ...
 */
    ...
    #define H5EA_IBLOCK_SIZE(i)                                                                                                                 \
        (                                                                                    /* General metadata fields */                      \
         H5EA_METADATA_PREFIX_SIZE(true)                                                     /* Sanity-checking fields */                       \
         + (i)->hdr->sizeof_addr /* File address of array owning the block */                /* Extensible Array Index Block specific fields */ \
    ...
    #define H5EA_SBLOCK_SIZE(s)                                                                                                                      \
        (                                                                /* General metadata fields */                                               \
         ...
         + (s)->hdr->arr_off_size /* Offset of the block in the array */ /* Extensible Array Super Block specific fields */                          \
    ...
    #define H5EA_DBLOCK_SIZE(d)                                                                                     \
        (                                                         /* Data block prefix size  */                     \
         H5EA_DBLOCK_PREFIX_SIZE(d)                               /* Extensible Array Data Block specific fields */ \
...
H5_DLL haddr_t H5EA__sblock_create(H5EA_hdr_t* hdr, H5EA_iblock_t* parent, bool* stats_changed, unsigned sblk_idx);
...
H5_DLL haddr_t H5EA__dblock_create(H5EA_hdr_t* hdr, void* parent, bool* stats_changed, hsize_t dblk_off, size_t nelmts);
