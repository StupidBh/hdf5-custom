 ...
 */
    ...
    #define H5FA_DBLOCK_PREFIX_SIZE(d)                                                                                                       \
        (                                                                                       /* General metadata fields */                \
         H5FA_METADATA_PREFIX_SIZE(true)                                                        /* Sanity-checking fields */                 \
         + (d)->hdr->sizeof_addr /* File address of Fixed Array header owning the data block */ /* Fixed Array Data Block specific fields */ \
    ...
    #define H5FA_DBLOCK_SIZE(d)                                                                                                                                \
        (                                                                                                          /* Data block prefix size  */               \
         H5FA_DBLOCK_PREFIX_SIZE(d)                                                                                /* Fixed Array Elements|Pages of Elements*/ \
         + ((d)->hdr->cparam.nelmts * (size_t)(d)->hdr->cparam.raw_elmt_size) + ((d)->npages * H5FA_SIZEOF_CHKSUM) /* Checksum */                              \
        )
