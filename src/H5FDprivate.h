...
H5_DLL herr_t H5FD_open(bool attempt, H5FD_t** file, const char* name, unsigned flags, hid_t fapl_id, haddr_t maxaddr);
...
H5_DLL herr_t H5FD_read_vector(H5FD_t* file, uint32_t count, H5FD_mem_t types[], haddr_t addrs[], size_t sizes[], void* bufs[] /* out */);
H5_DLL herr_t H5FD_write_vector(H5FD_t* file, uint32_t count, H5FD_mem_t types[], haddr_t addrs[], size_t sizes[], const void* bufs[] /* out */);
H5_DLL herr_t H5FD_read_selection(H5FD_t* file,
                                  H5FD_mem_t type,
                                  uint32_t count,
                                  ...
                                  void* bufs[] /* out */);
H5_DLL herr_t H5FD_write_selection(H5FD_t* file,
                                   H5FD_mem_t type,
                                   uint32_t count,
                                   struct H5S_t** mem_spaces,
                                   struct H5S_t** file_spaces,
                                   ...
                                   size_t element_sizes[],
                                   const void* bufs[]);
H5_DLL herr_t H5FD_read_selection_id(uint32_t skip_cb,
                                     H5FD_t* file,
                                     H5FD_mem_t type,
                                     uint32_t count,
                                     hid_t mem_space_ids[],
                                     ...
                                     size_t element_sizes[],
                                     void* bufs[] /* out */);
H5_DLL herr_t H5FD_write_selection_id(uint32_t skip_cb,
                                      H5FD_t* file,
                                      H5FD_mem_t type,
                                      uint32_t count,
                                      hid_t mem_space_ids[],
                                      ...
                                      size_t element_sizes[],
                                      const void* bufs[]);
H5_DLL herr_t H5FD_read_vector_from_selection(H5FD_t* file,
                                              H5FD_mem_t type,
                                              uint32_t count,
                                              hid_t mem_space_ids[],
                                              hid_t file_space_ids[],
...
H5_DLL herr_t H5FD_write_vector_from_selection(H5FD_t* file,
                                               H5FD_mem_t type,
                                               uint32_t count,
                                               hid_t mem_space_ids[],
                                               hid_t file_space_ids[],
...
H5_DLL herr_t H5FD_read_from_selection(H5FD_t* file,
                                       H5FD_mem_t type,
                                       uint32_t count,
                                       hid_t mem_space_ids[],
                                       hid_t file_space_ids[],
...
H5_DLL herr_t H5FD_write_from_selection(H5FD_t* file,
                                        H5FD_mem_t type,
                                        uint32_t count,
                                        hid_t mem_space_ids[],
                                        hid_t file_space_ids[],
...
H5_DLL herr_t H5FD_sort_vector_io_req(bool* vector_was_sorted,
                                      uint32_t count,
                                      H5FD_mem_t types[],
                                      haddr_t addrs[],
                                      size_t sizes[],
...
H5_DLL herr_t H5FD_sort_selection_io_req(bool* selection_was_sorted,
                                         size_t count,
                                         hid_t mem_space_ids[],
                                         hid_t file_space_ids[],
                                         haddr_t offsets[],
