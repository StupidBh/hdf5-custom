...
extern "C"
{
     ...
     * \since 2.2.0
     */
    H5_DLL herr_t H5Pget_fapl_ros3_block_caching(hid_t fapl_id, size_t* block_size, size_t* block_cache_size, bool* lock_superblock);
     ...
     * \since 2.2.0
     */
    H5_DLL herr_t H5Pset_fapl_ros3_block_caching(hid_t fapl_id, size_t block_size, size_t block_cache_size, bool lock_superblock);
