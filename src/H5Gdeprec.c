...
/* Local Prototypes */
/********************/
static herr_t H5G__get_objinfo_cb(H5G_loc_t* grp_loc /*in*/,
                                  const char* name,
...
H5G_obj_t H5G_map_obj_type(H5O_type_t obj_type)
{
    ...
    switch (obj_type) {
    case H5O_TYPE_GROUP: ret_value = H5G_GROUP; break;

    case H5O_TYPE_DATASET: ret_value = H5G_DATASET; break;

    case H5O_TYPE_NAMED_DATATYPE: ret_value = H5G_TYPE; break;
...
hid_t H5Gcreate1(hid_t loc_id, const char* name, size_t size_hint)
{
    ...
    /* Create the group */
    if (NULL == (grp = H5VL_group_create(vol_obj,
                                         &loc_params,
                                         name,
...
hid_t H5Gopen1(hid_t loc_id, const char* name)
{
    ...
    /* Open the group */
    if (NULL == (grp = H5VL_group_open(vol_obj, &loc_params, name, H5P_GROUP_ACCESS_DEFAULT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL))) {
...
herr_t H5Glink(hid_t cur_loc_id, H5G_link_t type, const char* cur_name, const char* new_name)
{
    ...
    if (type == H5L_TYPE_HARD) {
        ...
        if (H5VL_link_create(&vol_cb_args, vol_obj, &new_loc_params, H5P_LINK_CREATE_DEFAULT, H5P_LINK_ACCESS_DEFAULT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL) <
            0) {
        ...
        /* Create the link through the VOL */
        if (H5VL_link_create(&vol_cb_args, vol_obj, &loc_params, H5P_LINK_CREATE_DEFAULT, H5P_LINK_ACCESS_DEFAULT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL) < 0) {
            HGOTO_ERROR(H5E_SYM, H5E_CANTINIT, FAIL, "unable to create link");
        }
    } /* end else-if */
    else {
...
herr_t H5Glink2(hid_t cur_loc_id, const char* cur_name, H5G_link_t type, hid_t new_loc_id, const char* new_name)
{
    ...
    if (type == H5L_TYPE_HARD) {
        ...
        /* Create the link through the VOL */
        if (H5VL_link_create(&vol_cb_args, vol_obj2, &new_loc_params, H5P_LINK_CREATE_DEFAULT, H5P_LINK_ACCESS_DEFAULT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL) <
            0) {
            HGOTO_ERROR(H5E_SYM, H5E_CANTINIT, FAIL, "unable to create link");
        }
    } /* end if */
...
herr_t H5Gmove(hid_t src_loc_id, const char* src_name, const char* dst_name)
{
    ...
    /* Move the link */
    if (H5VL_link_move(vol_obj, &loc_params1, NULL, &loc_params2, H5P_LINK_CREATE_DEFAULT, H5P_LINK_ACCESS_DEFAULT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL) < 0) {
...
herr_t H5Gmove2(hid_t src_loc_id, const char* src_name, hid_t dst_loc_id, const char* dst_name)
{
    ...
    /* Move the link */
    if (H5VL_link_move(vol_obj1, &loc_params1, vol_obj2, &loc_params2, H5P_LINK_CREATE_DEFAULT, H5P_LINK_ACCESS_DEFAULT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL) <
        0) {
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Gget_num_objs(hid_t loc_id, hsize_t* num_objs /*out*/)
{
    H5VL_object_t* vol_obj = NULL;     /* Object of loc_id */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Gget_objinfo(hid_t loc_id, const char* name, bool follow_link, H5G_stat_t* statbuf /*out*/)
{
    H5VL_object_t* vol_obj = NULL;                  /* Object of loc_id */
    H5VL_optional_args_t vol_cb_args;               /* Arguments to VOL callback */
    H5VL_native_group_optional_args_t grp_opt_args; /* Arguments for optional operation */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5G__get_objinfo_cb(H5G_loc_t H5_ATTR_UNUSED* grp_loc /*in*/,
                                  const char* name,
                                  const H5O_link_t* lnk,
                                  H5G_loc_t* obj_loc,
                                  void* _udata /*in,out*/,
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5G__get_objinfo(const H5G_loc_t* loc, const char* name, bool follow_link, H5G_stat_t* statbuf /*out*/)
{
 ...
 *-------------------------------------------------------------------------
 */
ssize_t H5Gget_objname_by_idx(hid_t loc_id, hsize_t idx, char* name /*out*/, size_t size)
{
    H5VL_object_t* vol_obj;           /* Object of loc_id */
    H5VL_link_get_args_t vol_cb_args; /* Arguments to VOL callback */
    H5VL_loc_params_t loc_params;
