 ...
 */
typedef herr_t (*H5G_traverse_t)(H5G_loc_t* grp_loc /*in*/,
                                 const char* name,
                                 const struct H5O_link_t* lnk /*in*/,
...
H5_DLL herr_t H5G_iterate(H5G_loc_t* loc,
                          ...
                          void* op_data);
H5_DLL herr_t
    H5G_visit(H5G_loc_t* loc, const char* group_name, H5_index_t idx_type, H5_iter_order_t order, H5L_iterate2_t link_op, H5G_obj_iterate_t obj_op, void* op_data);
 ...
 */
H5_DLL herr_t H5G_obj_insert(const struct H5O_loc_t* grp_oloc, struct H5O_link_t* obj_lnk, bool adj_link, H5O_type_t obj_type, const void* crt_info);
H5_DLL herr_t
    H5G_obj_get_name_by_idx(const struct H5O_loc_t* oloc, H5_index_t idx_type, H5_iter_order_t order, hsize_t n, char* name, size_t name_size, size_t* name_len);
...
H5_DLL herr_t
    H5G_name_replace(const struct H5O_link_t* lnk, H5G_names_op_t op, H5F_t* src_file, H5RS_str_t* src_full_path_r, H5F_t* dst_file, H5RS_str_t* dst_full_path_r);
...
H5_DLL herr_t H5G_get_name(const H5G_loc_t* loc, char* name /*out*/, size_t size, size_t* name_len, bool* cached);
...
H5_DLL herr_t H5G_loc_find_by_idx(const H5G_loc_t* loc, const char* group_name, H5_index_t idx_type, H5_iter_order_t order, hsize_t n, H5G_loc_t* obj_loc /*out*/);
H5_DLL herr_t H5G_loc_exists(const H5G_loc_t* loc, const char* name, bool* exists);
H5_DLL herr_t H5G_loc_info(const H5G_loc_t* loc, const char* name, H5O_info2_t* oinfo /*out*/, unsigned fields);
H5_DLL herr_t H5G_loc_native_info(const H5G_loc_t* loc, const char* name, H5O_native_info_t* oinfo /*out*/, unsigned fields);
H5_DLL herr_t H5G_loc_set_comment(const H5G_loc_t* loc, const char* name, const char* comment);
H5_DLL herr_t H5G_loc_get_comment(const H5G_loc_t* loc, const char* name, char* comment /*out*/, size_t bufsize, size_t* comment_len);
