 ...
 */
#ifndef H5_DOXYGEN
    H5_DLL hid_t H5Gcreate_async(const char* app_file,
                                 const char* app_func,
                                 unsigned app_line,
                                 hid_t loc_id,
                                 const char* name,
 ...
 */
#ifndef H5_DOXYGEN
    H5_DLL hid_t H5Gopen_async(const char* app_file, const char* app_func, unsigned app_line, hid_t loc_id, const char* name, hid_t gapl_id, hid_t es_id);
#else
 ...
 */
#ifndef H5_DOXYGEN
    H5_DLL herr_t H5Gget_info_async(const char* app_file, const char* app_func, unsigned app_line, hid_t loc_id, H5G_info_t* ginfo /*out*/, hid_t es_id);
#else
 ...
 */
#ifndef H5_DOXYGEN
    H5_DLL herr_t H5Gget_info_by_name_async(const char* app_file,
                                            const char* app_func,
                                            unsigned app_line,
                                            hid_t loc_id,
                                            const char* name,
                                            ...
                                            hid_t es_id);
#else
H5_DLL herr_t H5Gget_info_by_name_async(hid_t loc_id, const char* name, H5G_info_t* ginfo /*out*/, hid_t lapl_id, hid_t es_id);
#endif
 ...
 */
#ifndef H5_DOXYGEN
    H5_DLL herr_t H5Gget_info_by_idx_async(const char* app_file,
                                           const char* app_func,
                                           unsigned app_line,
                                           hid_t loc_id,
                                           ...
                                           hid_t es_id);
#else
H5_DLL herr_t H5Gget_info_by_idx_async(hid_t loc_id,
                                       const char* group_name,
                                       H5_index_t idx_type,
                                       H5_iter_order_t order,
                                       hsize_t n,
 ...
 */
#ifndef H5_DOXYGEN
    H5_DLL herr_t H5Gclose_async(const char* app_file, const char* app_func, unsigned app_line, hid_t group_id, hid_t es_id);
#else
