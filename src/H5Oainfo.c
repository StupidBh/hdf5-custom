...
/* PRIVATE PROTOTYPES */
static void* H5O__ainfo_decode(H5F_t* f, H5O_t* open_oh, unsigned mesg_flags, unsigned* ioflags, size_t p_size, const uint8_t* p);
static herr_t H5O__ainfo_encode(H5F_t* f, bool disable_shared, size_t H5_ATTR_UNUSED p_size, uint8_t* p, const void* _mesg);
...
static herr_t H5O__ainfo_pre_copy_file(H5F_t* file_src, const void* mesg_src, bool* deleted, const H5O_copy_t* cpy_info, void* udata);
static void* H5O__ainfo_copy_file(H5F_t* file_src, void* mesg_src, H5F_t* file_dst, bool* recompute_size, unsigned* mesg_flags, H5O_copy_t* cpy_info, void* udata);
static herr_t
    H5O__ainfo_post_copy_file(const H5O_loc_t* src_oloc, const void* mesg_src, H5O_loc_t* dst_oloc, void* mesg_dst, unsigned* mesg_flags, H5O_copy_t* cpy_info);
 ...
 */
static void*
    H5O__ainfo_decode(H5F_t* f, H5O_t H5_ATTR_UNUSED* open_oh, unsigned H5_ATTR_UNUSED mesg_flags, unsigned H5_ATTR_UNUSED* ioflags, size_t p_size, const uint8_t* p)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__ainfo_encode(H5F_t* f, bool H5_ATTR_UNUSED disable_shared, size_t H5_ATTR_UNUSED p_size, uint8_t* p, const void* _mesg)
{
 ...
 *-------------------------------------------------------------------------
 */
static size_t H5O__ainfo_size(const H5F_t* f, bool H5_ATTR_UNUSED disable_shared, const void* _mesg)
{
    const H5O_ainfo_t* ainfo = (const H5O_ainfo_t*)_mesg;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__ainfo_free(void* mesg)
{
    FUNC_ENTER_PACKAGE_NOERR
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__ainfo_delete(H5F_t* f, H5O_t H5_ATTR_NDEBUG_UNUSED* open_oh, void* _mesg)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__ainfo_pre_copy_file(H5F_t H5_ATTR_UNUSED* file_src,
 ...
 *-------------------------------------------------------------------------
 */
static void* H5O__ainfo_copy_file(H5F_t H5_ATTR_NDEBUG_UNUSED* file_src,
                                  void* mesg_src,
                                  H5F_t* file_dst,
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5O__ainfo_debug(H5F_t H5_ATTR_UNUSED* f, const void* _mesg, FILE* stream, int indent, int fwidth)
{
    const H5O_ainfo_t* ainfo = (const H5O_ainfo_t*)_mesg;
    ...
    fprintf(stream, "%*s%-*s %s\n", indent, "", fwidth, "Track creation order of attributes:", ainfo->track_corder ? "TRUE" : "FALSE");
    fprintf(stream, "%*s%-*s %s\n", indent, "", fwidth, "Index creation order of attributes:", ainfo->index_corder ? "TRUE" : "FALSE");
    fprintf(stream, "%*s%-*s %u\n", indent, "", fwidth, "Max. creation index value:", (unsigned)ainfo->max_crt_idx);
    fprintf(stream, "%*s%-*s %" PRIuHADDR "\n", indent, "", fwidth, "'Dense' attribute storage fractal heap address:", ainfo->fheap_addr);
    fprintf(stream, "%*s%-*s %" PRIuHADDR "\n", indent, "", fwidth, "'Dense' attribute storage name index v2 B-tree address:", ainfo->name_bt2_addr);
    fprintf(stream, "%*s%-*s %" PRIuHADDR "\n", indent, "", fwidth, "'Dense' attribute storage creation order index v2 B-tree address:", ainfo->corder_bt2_addr);
