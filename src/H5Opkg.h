 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    #define H5O_SIZEOF_HDR(O)                                                                                                  \
        (((O)->version == H5O_VERSION_1) ? H5O_ALIGN_OLD(1 +                           /*version number	*/                     \
                                                         1 +                           /*reserved 		*/                         \
...
struct H5O_msg_class_t
{
    ...
    herr_t (*pre_copy_file)(H5F_t*, const void*, bool*, const H5O_copy_t*, void*);                      /*"pre copy" action when copying native value to file */
    void* (*copy_file)(H5F_t*, void*, H5F_t*, bool*, unsigned*, H5O_copy_t*, void*);                    /*copy native value to file */
...
H5_DLL herr_t H5O__copy(const H5G_loc_t* src_loc, const char* src_name, H5G_loc_t* dst_loc, const char* dst_name, hid_t ocpypl_id, hid_t lcpl_id);
