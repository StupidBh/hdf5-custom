...
static const bool H5F_def_want_posix_fd_g = H5F_ACS_WANT_POSIX_FD_DEF;                            /* Default setting for retrieving 'handle' from core VFD */
...
static const bool H5F_def_clear_status_flags_g = H5F_ACS_CLEAR_STATUS_FLAGS_DEF;                  /* Default to clear the superblock status_flags */
static const bool H5F_def_skip_eof_check_g = H5F_ACS_SKIP_EOF_CHECK_DEF;                          /* Default setting for skipping EOF check */
static const bool H5F_def_null_fsm_addr_g = H5F_ACS_NULL_FSM_ADDR_DEF;                            /* Default setting for dropping free-space to the floor */

static const bool H5F_def_use_mdc_logging_g = H5F_ACS_USE_MDC_LOGGING_DEF;                        /* Default metadata cache logging flag */
static const char* H5F_def_mdc_log_location_g = H5F_ACS_MDC_LOG_LOCATION_DEF;                     /* Default mdc log location */
static const bool H5F_def_start_mdc_log_on_access_g = H5F_ACS_START_MDC_LOG_ON_ACCESS_DEF;        /* Default mdc log start on access flag */
static const bool H5F_def_evict_on_close_flag_g = H5F_ACS_EVICT_ON_CLOSE_FLAG_DEF;                /* Default setting for evict on close property */
#ifdef H5_HAVE_PARALLEL
...
static const bool H5F_def_coll_md_write_flag_g = H5F_ACS_COLL_MD_WRITE_FLAG_DEF;                  /* Default setting for the collective metedata write flag */
...
static const unsigned H5F_def_page_buf_min_raw_perc_g = H5F_ACS_PAGE_BUFFER_MIN_RAW_PERC_DEF;                      /* Default page buffer minimum raw data size */
static const bool H5F_def_use_file_locking_g = H5F_ACS_USE_FILE_LOCKING_DEF;                                       /* Default use file locking flag */
static const bool H5F_def_ignore_disabled_file_locks_g = H5F_ACS_IGNORE_DISABLED_FILE_LOCKS_DEF;                   /* Default ignore disabled file locks flag */
...
static herr_t H5P__facc_reg_prop(H5P_genclass_t* pclass)
{
    ...
    if (H5P__register_real(pclass,
                           ...
                           &H5F_def_metadata_read_attempts_g,
                           NULL,
                           NULL,
                           NULL,
    ...
    if (H5P__register_real(pclass,
                           ...
                           &H5F_def_start_mdc_log_on_access_g,
                           NULL,
                           NULL,
                           NULL,
    ...
    if (H5P__register_real(pclass,
                           ...
                           H5F_ACS_COLL_MD_READ_FLAG_SIZE,
                           &H5F_def_coll_md_read_flag_g,
                           NULL,
                           NULL,
                           NULL,
                           H5F_ACS_COLL_MD_READ_FLAG_ENC,
                           H5F_ACS_COLL_MD_READ_FLAG_DEC,
                           NULL,
                           NULL,
                           NULL,
                           NULL) < 0) {
    ...
    if (H5P__register_real(pclass,
                           ...
                           H5F_ACS_COLL_MD_WRITE_FLAG_SIZE,
                           &H5F_def_coll_md_write_flag_g,
                           NULL,
                           NULL,
                           NULL,
                           H5F_ACS_COLL_MD_WRITE_FLAG_ENC,
                           H5F_ACS_COLL_MD_WRITE_FLAG_DEC,
                           NULL,
                           NULL,
                           NULL,
                           NULL) < 0) {
    ...
    if (H5P__register_real(pclass,
                           H5F_ACS_MPI_PARAMS_COMM_NAME,
                           H5F_ACS_MPI_PARAMS_COMM_SIZE,
                           &H5F_def_mpi_params_comm_g,
                           NULL,
                           H5F_ACS_MPI_PARAMS_COMM_SET,
                           H5F_ACS_MPI_PARAMS_COMM_GET,
                           NULL,
                           NULL,
                           H5F_ACS_MPI_PARAMS_COMM_DEL,
                           H5F_ACS_MPI_PARAMS_COMM_COPY,
                           H5F_ACS_MPI_PARAMS_COMM_CMP,
    ...
    if (H5P__register_real(pclass,
                           H5F_ACS_MPI_PARAMS_INFO_NAME,
                           H5F_ACS_MPI_PARAMS_INFO_SIZE,
                           &H5F_def_mpi_params_info_g,
                           NULL,
                           H5F_ACS_MPI_PARAMS_INFO_SET,
                           H5F_ACS_MPI_PARAMS_INFO_GET,
                           NULL,
                           NULL,
                           H5F_ACS_MPI_PARAMS_INFO_DEL,
                           H5F_ACS_MPI_PARAMS_INFO_COPY,
                           H5F_ACS_MPI_PARAMS_INFO_CMP,
    ...
    if (H5P__register_real(pclass,
                           ...
                           &H5F_def_mdc_initCacheImageCfg_g,
                           NULL,
                           NULL,
                           NULL,
    ...
    if (H5P__register_real(pclass,
                           ...
                           &H5F_def_page_buf_min_meta_perc_g,
                           NULL,
                           NULL,
                           NULL,
    ...
    if (H5P__register_real(pclass,
                           ...
                           &H5F_def_page_buf_min_raw_perc_g,
                           NULL,
                           NULL,
                           NULL,
    ...
    if (H5P__register_real(pclass,
                           H5F_ACS_USE_FILE_LOCKING_NAME,
                           H5F_ACS_USE_FILE_LOCKING_SIZE,
                           &H5F_def_use_file_locking_g,
                           NULL,
                           NULL,
                           NULL,
                           H5F_ACS_USE_FILE_LOCKING_ENC,
                           H5F_ACS_USE_FILE_LOCKING_DEC,
                           NULL,
                           NULL,
                           NULL,
                           NULL) < 0) {
    ...
    if (H5P__register_real(pclass,
                           ...
                           H5F_ACS_IGNORE_DISABLED_FILE_LOCKS_SIZE,
                           &H5F_def_ignore_disabled_file_locks_g,
                           NULL,
                           NULL,
                           NULL,
                           H5F_ACS_IGNORE_DISABLED_FILE_LOCKS_ENC,
                           H5F_ACS_IGNORE_DISABLED_FILE_LOCKS_DEC,
                           NULL,
                           NULL,
                           NULL,
                           NULL) < 0) {
    ...
    if (H5P__register_real(pclass,
                           H5F_ACS_RFIC_FLAGS_NAME,
                           H5F_ACS_RFIC_FLAGS_SIZE,
                           &H5F_def_rfic_flags_g,
                           NULL,
                           NULL,
                           NULL,
                           H5F_ACS_RFIC_FLAGS_ENC,
                           H5F_ACS_RFIC_FLAGS_DEC,
                           NULL,
                           NULL,
                           NULL,
                           NULL) < 0) {
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5P_set_driver(H5P_genplist_t* plist, hid_t new_driver_id, const void* new_driver_info, const char* new_driver_config_str)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5P_set_driver_by_name(H5P_genplist_t* plist, const char* driver_name, const char* driver_config, bool app_ref)
{
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5P_set_driver_by_value(H5P_genplist_t* plist, H5FD_class_value_t driver_value, const char* driver_config, bool app_ref)
{
    hid_t new_driver_id = H5I_INVALID_HID;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_driver_create(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_driver_set(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_driver_get(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_driver_del(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_driver_copy(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_driver_close(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Pget_cache(hid_t plist_id, int* mdc_nelmts, size_t* rdcc_nslots /*out*/, size_t* rdcc_nbytes /*out*/, double* rdcc_w0 /*out*/)
{
    H5P_genplist_t* plist;      /* Property list pointer */
    herr_t ret_value = SUCCEED; /* return value */
...
herr_t H5Pset_file_image(hid_t fapl_id, void* buf_ptr, size_t buf_len)
{
    ...
    if (image_info.buffer != NULL) {
        if (image_info.callbacks.image_free) {
            ...
            {
                ret_value = image_info.callbacks.image_free(image_info.buffer, H5FD_FILE_IMAGE_OP_PROPERTY_LIST_SET, image_info.callbacks.udata);
            }
    ...
    if (buf_ptr) {
        ...
        if (image_info.callbacks.image_malloc) {
            ...
            H5_BEFORE_USER_CB(FAIL)
            {
                image_info.buffer = image_info.callbacks.image_malloc(buf_len, H5FD_FILE_IMAGE_OP_PROPERTY_LIST_SET, image_info.callbacks.udata);
            }
            H5_AFTER_USER_CB(FAIL)
        ...
        if (image_info.callbacks.image_memcpy) {
            ...
            H5_BEFORE_USER_CB(FAIL)
            {
                tmp = image_info.callbacks.image_memcpy(image_info.buffer, buf_ptr, buf_len, H5FD_FILE_IMAGE_OP_PROPERTY_LIST_SET, image_info.callbacks.udata);
            }
            H5_AFTER_USER_CB(FAIL)
...
herr_t H5Pget_file_image(hid_t fapl_id, void** buf /*out*/, size_t* buf_len /*out*/)
{
    ...
    assert(((image_info.buffer != NULL) && (image_info.size > 0)) || ((image_info.buffer == NULL) && (image_info.size == 0)));
    ...
    if (buf != NULL) {
        ...
        if (image_info.buffer != NULL) {
            ...
            if (image_info.callbacks.image_malloc) {
                ...
                H5_BEFORE_USER_CB(FAIL)
                {
                    copy_ptr = image_info.callbacks.image_malloc(image_info.size, H5FD_FILE_IMAGE_OP_PROPERTY_LIST_GET, image_info.callbacks.udata);
                }
                H5_AFTER_USER_CB(FAIL)
                if (NULL == copy_ptr) {
                    HGOTO_ERROR(H5E_PLIST, H5E_CANTALLOC, FAIL, "image malloc callback failed");
            ...
            if (image_info.callbacks.image_memcpy) {
                ...
                H5_BEFORE_USER_CB(FAIL)
                {
                    tmp = image_info.callbacks.image_memcpy(copy_ptr,
                                                            image_info.buffer,
                                                            image_info.size,
    ...
    if (value) {
        ...
        if (info->buffer && info->size > 0) {
            ...
            if (info->callbacks.image_malloc) {
                ...
                H5_BEFORE_USER_CB(FAIL)
                {
                    info->buffer = info->callbacks.image_malloc(info->size, H5FD_FILE_IMAGE_OP_PROPERTY_LIST_COPY, info->callbacks.udata);
                }
                H5_AFTER_USER_CB(FAIL)
                if (NULL == info->buffer) {
                    HGOTO_ERROR(H5E_PLIST, H5E_CANTALLOC, FAIL, "image malloc callback failed");
            ...
            if (info->callbacks.image_memcpy) {
                ...
                H5_BEFORE_USER_CB(FAIL)
                {
                    tmp = info->callbacks.image_memcpy(info->buffer, old_buffer, info->size, H5FD_FILE_IMAGE_OP_PROPERTY_LIST_COPY, info->callbacks.udata);
                }
                H5_AFTER_USER_CB(FAIL)
                if (info->buffer != tmp) {
                    HGOTO_ERROR(H5E_PLIST, H5E_CANTCOPY, FAIL, "image_memcpy callback failed");
    ...
    if (value) {
        ...
        if (info->buffer != NULL && info->size > 0) {
            if (info->callbacks.image_free) {
                ...
                H5_BEFORE_USER_CB(FAIL)
                {
                    ret_value = (*info->callbacks.image_free)(info->buffer, H5FD_FILE_IMAGE_OP_PROPERTY_LIST_CLOSE, info->callbacks.udata);
                }
                H5_AFTER_USER_CB(FAIL)
                if (ret_value < 0) {
                    HGOTO_ERROR(H5E_PLIST, H5E_CANTFREE, FAIL, "image_free callback failed");
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_image_info_set(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_image_info_get(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_image_info_del(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_image_info_copy(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_file_image_info_close(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
...
static herr_t H5P__facc_cache_config_enc(const void* value, void** _pp, size_t* size)
{
    ...
    *size += 1 + H5VM_limit_enc_size(enc_value);
    ...
    /* Compute encoded size of fixed-size values */
    *size += (5 + (sizeof(unsigned) * 8) + (sizeof(double) * 8) + (sizeof(int32_t) * 4) + sizeof(int64_t) + H5AC__MAX_TRACE_FILE_NAME_LEN + 1);
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Pget_mdc_log_options(hid_t plist_id, bool* is_enabled /*out*/, char* location /*out*/, size_t* location_size /*out*/, bool* start_on_access /*out*/)
{
    H5P_genplist_t* plist;      /* Property list pointer */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mdc_log_location_del(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    FUNC_ENTER_PACKAGE_NOERR
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mdc_log_location_copy(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    FUNC_ENTER_PACKAGE_NOERR
 ...
 *-------------------------------------------------------------------------
 */
static H5_ATTR_PURE int H5P__facc_mdc_log_location_cmp(const void* value1, const void* value2, size_t H5_ATTR_UNUSED size)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mdc_log_location_close(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    FUNC_ENTER_PACKAGE_NOERR
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Pget_evict_on_close(hid_t fapl_id, bool* evict_on_close /*out*/)
{
    H5P_genplist_t* plist;      /* property list pointer */
    herr_t ret_value = SUCCEED; /* return value */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Pget_file_locking(hid_t fapl_id, bool* use_file_locking /*out*/, bool* ignore_when_disabled /*out*/)
{
    H5P_genplist_t* plist;      /* property list pointer */
    herr_t ret_value = SUCCEED; /* return value */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Pget_all_coll_metadata_ops(hid_t plist_id, bool* is_collective /*out*/)
{
    herr_t ret_value = SUCCEED; /* return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_comm_set(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_comm_get(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Comm* comm = (MPI_Comm*)value;
    MPI_Comm comm_tmp = MPI_COMM_NULL;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_comm_del(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Comm* comm = (MPI_Comm*)value;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_comm_copy(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Comm* comm = (MPI_Comm*)value;
    MPI_Comm comm_tmp = MPI_COMM_NULL;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_comm_close(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Comm* comm = (MPI_Comm*)value;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_info_set(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_info_get(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Info* info = (MPI_Info*)value;
    MPI_Info info_tmp = MPI_INFO_NULL;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_info_del(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Info* info = (MPI_Info*)value;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_info_copy(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Info* info = (MPI_Info*)value;
    MPI_Info info_tmp = MPI_INFO_NULL;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_mpi_info_close(const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    MPI_Info* info = (MPI_Info*)value;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Pget_coll_metadata_write(hid_t plist_id, bool* is_collective /*out*/)
{
    H5P_genplist_t* plist;      /* Property list pointer */
    herr_t ret_value = SUCCEED; /* return value */
...
herr_t H5Pset_page_buffer_size(hid_t plist_id, size_t buf_size, unsigned min_meta_perc, unsigned min_raw_perc)
{
    ...
    if (min_raw_perc > 100) {
        HGOTO_ERROR(H5E_ARGS, H5E_BADVALUE, FAIL, "Minimum raw data fractions must be between 0 and 100 inclusive");
    }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Pget_page_buffer_size(hid_t plist_id, size_t* buf_size /*out*/, unsigned* min_meta_perc /*out*/, unsigned* min_raw_perc /*out*/)
{
    H5P_genplist_t* plist;      /* Property list pointer */
    herr_t ret_value = SUCCEED; /* return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_page_buffer_size_dec(const void** _pp, void* _value)
{
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_vol_set(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_vol_get(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5P__facc_vol_del(hid_t H5_ATTR_UNUSED prop_id, const char H5_ATTR_UNUSED* name, size_t H5_ATTR_UNUSED size, void* value)
{
    herr_t ret_value = SUCCEED; /* Return value */
...
{
    const H5VL_connector_prop_t* prop1 = (const H5VL_connector_prop_t*)_prop1; /* Create local aliases for values */
