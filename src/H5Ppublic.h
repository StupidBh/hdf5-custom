...
#define H5D_SELECTION_IO (0x0004u) /**< Selection I/O was performed */
     ...
     *
     */
    H5_DLL herr_t H5Pmodify_filter(hid_t plist_id, H5Z_filter_t filter, unsigned int flags, size_t cd_nelmts, const unsigned int cd_values[/*cd_nelmts*/]);
    /**
     * \ingroup OCPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pset_filter(hid_t plist_id, H5Z_filter_t filter, unsigned int flags, size_t cd_nelmts, const unsigned int cd_values[]);
    /**
     * \ingroup OCPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pget_file_space_strategy(hid_t plist_id, H5F_fspace_strategy_t* strategy, bool* persist, hsize_t* threshold);
    /**
     * \ingroup FCPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pset_file_space_strategy(hid_t plist_id, H5F_fspace_strategy_t strategy, bool persist, hsize_t threshold);
    /**
     * \ingroup FCPL
     *
     ...
     * \since 1.10.0
     */
    H5_DLL herr_t H5Pget_mdc_log_options(hid_t plist_id, bool* is_enabled, char* location, size_t* location_size, bool* start_on_access);
    /**
     * \ingroup FAPL
     *
     ...
     * \since 1.10.1
     */
    H5_DLL herr_t H5Pget_page_buffer_size(hid_t plist_id, size_t* buf_size, unsigned* min_meta_perc, unsigned* min_raw_perc);
    /**
     * \ingroup FAPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pget_external(hid_t plist_id, unsigned idx, size_t name_size, char* name /*out*/, HDoff_t* offset /*out*/, hsize_t* size /*out*/);
    /**
     * \ingroup DCPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pget_append_flush(hid_t dapl_id, unsigned dims, hsize_t boundary[], H5D_append_cb_t* func, void** udata);
    /**
     * \ingroup DAPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pget_chunk_cache(hid_t dapl_id, size_t* rdcc_nslots /*out*/, size_t* rdcc_nbytes /*out*/, double* rdcc_w0 /*out*/);
    /**
     * \ingroup DAPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pset_append_flush(hid_t dapl_id, unsigned ndims, const hsize_t boundary[], H5D_append_cb_t func, void* udata);
    /**
     * \ingroup DAPL
     *
     * \brief Sets the raw data chunk cache parameters
     ...
     *
     */
    H5_DLL herr_t H5Pget_btree_ratios(hid_t plist_id, double* left /*out*/, double* middle /*out*/, double* right /*out*/);
    /**
     *
     * \ingroup  DXPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pset_dataset_io_hyperslab_selection(hid_t plist_id,
                                                        unsigned rank,
                                                        H5S_seloper_t op,
                                                        const hsize_t start[],
 ...
 */
     ...
     *
     */
    H5_DLL herr_t H5Pget_version(hid_t plist_id, unsigned* boot /*out*/, unsigned* freelist /*out*/, unsigned* stab /*out*/, unsigned* shhdr /*out*/);
    /**
     * \ingroup FCPL
     *
