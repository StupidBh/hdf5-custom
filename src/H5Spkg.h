 ...
 */
    ...
    #define H5S_SELECT_INFO_ENC_SIZE_BITS (H5S_SELECT_INFO_ENC_SIZE_2 | H5S_SELECT_INFO_ENC_SIZE_4 | H5S_SELECT_INFO_ENC_SIZE_8)
...
typedef herr_t (*H5S_sel_deserialize_func_t)(H5S_t** space, const uint8_t** p, const size_t p_size, bool skip);
...
H5_DLL herr_t H5S__hyper_project_intersection(H5S_t* src_space, H5S_t* dst_space, H5S_t* src_intersect_space, H5S_t* proj_space, bool share_space);
