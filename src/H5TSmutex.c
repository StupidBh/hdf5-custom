 ...
 *-------------------------------------------------------------------------
 */
herr_t H5TS_mutex_init(H5TS_mutex_t* mutex, int type)
{
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5TS_mutex_trylock(H5TS_mutex_t* mutex, bool* acquired)
{
    int rc;
    herr_t ret_value = SUCCEED;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5TS_mutex_destroy(H5TS_mutex_t* mutex)
{
    FUNC_ENTER_NOAPI_NAMECHECK_ONLY
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5TS_mutex_init(H5TS_mutex_t* mutex, int H5_ATTR_UNUSED type)
{
    FUNC_ENTER_NOAPI_NAMECHECK_ONLY
