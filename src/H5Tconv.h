...
typedef herr_t (*H5T_lib_conv_t)(const H5T_t* src,
                                 const H5T_t* dst,
                                 H5T_cdata_t* cdata,
...
H5_DLL herr_t
    H5T_convert(H5T_path_t* tpath, const H5T_t* src_type, const H5T_t* dst_type, size_t nelmts, size_t buf_stride, size_t bkg_stride, void* buf, void* bkg);

/* Helper function for H5T_convert that accepts a pointer to a H5T_conv_ctx_t structure */
H5_DLL herr_t H5T_convert_with_ctx(H5T_path_t* tpath,
...
H5_DLL herr_t H5T__conv_noop(const H5T_t* src,
                             const H5T_t* dst,
                             H5T_cdata_t* cdata,
                             const H5T_conv_ctx_t* conv_ctx,
                             size_t nelmts,
                             ...
                             void* _buf,
                             void* bkg);
H5_DLL herr_t H5T__conv_order(const H5T_t* src,
                              const H5T_t* dst,
                              H5T_cdata_t* cdata,
                              const H5T_conv_ctx_t* conv_ctx,
                              size_t nelmts,
                              ...
                              void* _buf,
                              void* bkg);
H5_DLL herr_t H5T__conv_order_opt(const H5T_t* src,
                                  const H5T_t* dst,
                                  H5T_cdata_t* cdata,
                                  const H5T_conv_ctx_t* conv_ctx,
                                  size_t nelmts,
