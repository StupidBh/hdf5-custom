 ...
 *-------------------------------------------------------------------------
 */
herr_t H5T__conv_array(const H5T_t* src,
                       const H5T_t* dst,
                       H5T_cdata_t* cdata,
                       ...
                       void* _bkg)
{
    ...
    case H5T_CONV_CONV:
        ...
        for (size_t elmtno = 0; elmtno < nelmts; elmtno++) {
            ...
            /* Convert array */
            if (H5T_convert_with_ctx(priv->tpath, tsrc_cpy, tdst_cpy, &tmp_conv_ctx, src->shared->u.array.nelem, (size_t)0, (size_t)0, dp, bp) < 0) {
