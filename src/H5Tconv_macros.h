...
#define H5T_CONV_uS_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) { H5T_CONV_uS_CORE_I(H5T_CONV_uS_EVAL_TYPES(STYPE, DTYPE), S, D, ST, DT, D_MIN, D_MAX) }
...
#define H5T_CONV_uS_NOEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) { H5T_CONV_uS_NOEX_CORE_I(H5T_CONV_uS_EVAL_TYPES(STYPE, DTYPE), S, D, ST, DT, D_MIN, D_MAX) }
...
#define H5T_CONV_Xf(STYPE, DTYPE, ST, DT, D_MIN, D_MAX)              \
     ...
     */
        ...
        #define H5T_CONV_CAST_Zz(STYPE, DTYPE, S, S_REAL, S_IMAG, D, ST, DT) { H5T_CONV_CAST_TO_##DTYPE(S_REAL, S_IMAG, D, DT) }
        ...
        #define H5T_CONV_CAST_fZ(STYPE, DTYPE, S, S_REAL, S_IMAG, D, ST, DT) { H5T_CONV_CAST_TO_##DTYPE(*(S), (ST)0.0, D, DT) }
        #define H5T_CONV_CAST_Fz(STYPE, DTYPE, S, S_REAL, S_IMAG, D, ST, DT) { H5T_CONV_CAST_TO_##DTYPE(*(S), (ST)0.0, D, DT) }
        #define H5T_CONV_CAST_fz(STYPE, DTYPE, S, S_REAL, S_IMAG, D, ST, DT) { H5T_CONV_CAST_TO_##DTYPE(*(S), (ST)0.0, D, DT) }
        #define H5T_CONV_CAST_xZ(STYPE, DTYPE, S, S_REAL, S_IMAG, D, ST, DT) { H5T_CONV_CAST_TO_##DTYPE(*(S), (ST)0.0, D, DT) }
    ...
    #define H5T_CONV_zZ_NOEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_zZ_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)
    ...
    #define H5T_CONV_zF_NOEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_zF_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)
    ...
    #define H5T_CONV_Zf_FLOAT_COMPLEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)   H5T_CONV_Zf_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, float, D_MIN, D_MAX)
    #define H5T_CONV_Zf_DOUBLE_COMPLEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)  H5T_CONV_Zf_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, double, D_MIN, D_MAX)
    #define H5T_CONV_Zf_LDOUBLE_COMPLEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_Zf_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, long double, D_MIN, D_MAX)
    ...
    #define H5T_CONV_Zf_FLOAT_COMPLEX_NOEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_Zf_NOEX_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, float, D_MIN, D_MAX)
    ...
    #define H5T_CONV_fZ_NOEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_fZ_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)
    ...
    #define H5T_CONV_Zx_FLOAT_COMPLEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)   H5T_CONV_Zx_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, float, D_MIN, D_MAX)
    #define H5T_CONV_Zx_DOUBLE_COMPLEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)  H5T_CONV_Zx_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, double, D_MIN, D_MAX)
    #define H5T_CONV_Zx_LDOUBLE_COMPLEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_Zx_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, long double, D_MIN, D_MAX)
    ...
    #define H5T_CONV_Zx_FLOAT_COMPLEX_NOEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_Zx_NOEX_CORE_IMP(STYPE, DTYPE, S, D, ST, DT, float, D_MIN, D_MAX)
    ...
    #define H5T_CONV_zX_NOEX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) H5T_CONV_zX_CORE(STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX)
...
#define H5T_CONV_LOOP(PRE_SALIGN_GUTS, PRE_DALIGN_GUTS, POST_SALIGN_GUTS, POST_DALIGN_GUTS, GUTS, STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) \
    for (elmtno = 0; elmtno < safe; elmtno++) {                                                                                             \
        ...
        (ST)                                                                   /* Handle destination pre-alignment */                       \
            H5_GLUE(H5T_CONV_LOOP_, PRE_DALIGN_GUTS)(DT)                       /* ... user-defined stuff here -- the conversion ... */      \
            H5T_CONV_LOOP_GUTS(GUTS, STYPE, DTYPE, S, D, ST, DT, D_MIN, D_MAX) /* Handle source post-alignment */                           \
            H5_GLUE(H5T_CONV_LOOP_, POST_SALIGN_GUTS)(ST)                      /* Handle destination post-alignment */                      \
            H5_GLUE(H5T_CONV_LOOP_, POST_DALIGN_GUTS)(DT)                      /* Advance pointers */                                       \
        ...
        {                                                                                                                                                   \
            ...
            case H5T_CONV_CONV:                                                                                                                             \
                if (NULL == st || NULL == dt)                                                                                                               \
                    HGOTO_ERROR(H5E_DATATYPE, H5E_CANTINIT, FAIL, "invalid datatype");                                                                      \
                if (NULL == conv_ctx)                                                                                                                       \
                    HGOTO_ERROR(H5E_DATATYPE, H5E_CANTINIT, FAIL, "invalid datatype conversion context pointer");                                           \
                                                                                                                                                            \
                ...
                s_mv = H5T_NATIVE_##STYPE##_ALIGN_g > 1 && ((size_t)buf % H5T_NATIVE_##STYPE##_ALIGN_g || /* Cray */ ((size_t)((ST*)buf) != (size_t)buf) || \
                                                            (size_t)s_stride % H5T_NATIVE_##STYPE##_ALIGN_g);                                               \
                d_mv = H5T_NATIVE_##DTYPE##_ALIGN_g > 1 && ((size_t)buf % H5T_NATIVE_##DTYPE##_ALIGN_g || /* Cray */ ((size_t)((DT*)buf) != (size_t)buf) || \
