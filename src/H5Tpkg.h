 ...
 */
    ...
    #define H5T_IS_COMPOSITE(t) ((t) == H5T_COMPOUND || (t) == H5T_ENUM || (t) == H5T_VLEN || (t) == H5T_ARRAY || (t) == H5T_REFERENCE || (t) == H5T_COMPLEX)
...
typedef size_t (*H5T_ref_getsizefunc_t)(H5VL_object_t* src_file, const void* src_buf, size_t src_size, H5VL_object_t* dst_file, bool* dst_copy);
...
typedef herr_t (*H5T_ref_writefunc_t)(H5VL_object_t* src_file,
                                      const void* src_buf,
                                      size_t src_size,
                                      H5R_type_t src_type,
...
typedef herr_t (
    *H5T_vlen_write_func_t)(H5VL_object_t* file, const H5T_vlen_alloc_info_t* vl_alloc_info, void* _vl, void* buf, void* _bg, size_t seq_len, size_t base_size);
...
H5_DLL ssize_t H5T__bit_find(const uint8_t* buf, size_t offset, size_t size, H5T_sdir_t direction, bool value);
