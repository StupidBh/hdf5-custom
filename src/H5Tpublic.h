 ...
 */
#ifndef H5_DOXYGEN
    H5_DLL herr_t H5Tcommit_async(const char* app_file,
                                  const char* app_func,
                                  unsigned app_line,
                                  hid_t loc_id,
                                  const char* name,
                                  ...
                                  hid_t es_id);
#else
H5_DLL herr_t H5Tcommit_async(hid_t loc_id, const char* name, hid_t type_id, hid_t lcpl_id, hid_t tcpl_id, hid_t tapl_id, hid_t es_id);
#endif
    /**
     * --------------------------------------------------------------------------
     * \ingroup H5T
...
H5_DLL hid_t H5Topen_async(hid_t loc_id, const char* name, hid_t tapl_id, hid_t es_id);
     ...
     *
     */
    H5_DLL herr_t H5Tget_fields(hid_t type_id, size_t* spos /*out*/, size_t* epos /*out*/, size_t* esize /*out*/, size_t* mpos /*out*/, size_t* msize /*out*/);
    /**
     * \ingroup ATOM
     *
...
/* (And must only defined when included in application code, not the library) */
     ...
     *
     */
    H5_DLL hid_t H5Tarray_create1(hid_t base_id, int ndims, const hsize_t dim[/* ndims */], const int perm[/* ndims */]);
    /**
     * \ingroup ARRAY
     *
     * \brief Retrieves sizes of array dimensions
