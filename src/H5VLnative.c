...
#define H5VL_NATIVE_CAP_FLAGS                                                                                                                                      \
    (H5VL_CAP_FLAG_NATIVE_FILES | H5VL_CAP_FLAG_ATTR_BASIC | H5VL_CAP_FLAG_ATTR_MORE | H5VL_CAP_FLAG_DATASET_BASIC | H5VL_CAP_FLAG_DATASET_MORE |                  \
     H5VL_CAP_FLAG_FILE_BASIC | H5VL_CAP_FLAG_FILE_MORE | H5VL_CAP_FLAG_GROUP_BASIC | H5VL_CAP_FLAG_GROUP_MORE | H5VL_CAP_FLAG_LINK_BASIC |                        \
     H5VL_CAP_FLAG_LINK_MORE | H5VL_CAP_FLAG_OBJECT_BASIC | H5VL_CAP_FLAG_OBJECT_MORE | H5VL_CAP_FLAG_REF_BASIC | H5VL_CAP_FLAG_REF_MORE | H5VL_CAP_FLAG_OBJ_REF | \
     H5VL_CAP_FLAG_REG_REF | H5VL_CAP_FLAG_ATTR_REF | H5VL_CAP_FLAG_STORED_DATATYPES | H5VL_CAP_FLAG_CREATION_ORDER | H5VL_CAP_FLAG_ITERATE |                      \
     H5VL_CAP_FLAG_STORAGE_SIZE | H5VL_CAP_FLAG_BY_IDX | H5VL_CAP_FLAG_GET_PLIST | H5VL_CAP_FLAG_FLUSH_REFRESH | H5VL_CAP_FLAG_EXTERNAL_LINKS |                    \
     H5VL_CAP_FLAG_HARD_LINKS | H5VL_CAP_FLAG_SOFT_LINKS | H5VL_CAP_FLAG_UD_LINKS | H5VL_CAP_FLAG_TRACK_TIMES | H5VL_CAP_FLAG_MOUNT | H5VL_CAP_FLAG_FILTERS |      \
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_register(void)
{
 ...
 *---------------------------------------------------------------------------
 */
herr_t H5VL__native_unregister(void)
{
 ...
 *---------------------------------------------------------------------------
 */
herr_t H5VL__native_introspect_get_cap_flags(const void H5_ATTR_UNUSED* info, uint64_t* cap_flags)
{
    FUNC_ENTER_PACKAGE_NOERR
...
herr_t H5VL_native_get_file_struct(void* obj, H5I_type_t type, H5F_t** file)
{
    ...
    *file = NULL;
    ...
    switch (type) {
    case H5I_FILE: *file = (H5F_t*)obj; break;

    case H5I_GROUP: oloc = H5G_oloc((H5G_t*)obj); break;

    case H5I_DATATYPE: oloc = H5T_oloc((H5T_t*)obj); break;

    case H5I_DATASET: oloc = H5D_oloc((H5D_t*)obj); break;

    case H5I_ATTR: oloc = H5A_oloc((H5A_t*)obj); break;

    case H5I_MAP: HGOTO_ERROR(H5E_ARGS, H5E_BADTYPE, FAIL, "maps not supported in native VOL connector");
    ...
    case H5I_EVENTSET:
    case H5I_NTYPES:
    default                : HGOTO_ERROR(H5E_ARGS, H5E_BADTYPE, FAIL, "not a file or file object");
    } /* end switch */
