 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_file_get(void* obj, H5VL_file_get_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    ...
    case H5VL_FILE_GET_NAME:
        {
            ...
            *file_args->file_name_len = strlen(H5F_OPEN_NAME(f));
            ...
            if (file_args->buf) {
                strncpy(file_args->buf, H5F_OPEN_NAME(f), MIN(*file_args->file_name_len + 1, file_args->buf_size));
    ...
    case H5VL_FILE_GET_OBJ_COUNT:
        {
            if (H5F_get_obj_count((H5F_t*)obj, args->args.get_obj_count.types, true, args->args.get_obj_count.count) < 0) {
    ...
    case H5VL_FILE_GET_OBJ_IDS:
        {
            ...
            if (H5F_get_obj_ids((H5F_t*)obj, file_args->types, file_args->max_objs, file_args->oid_list, true, file_args->count) < 0) {
    ...
    default: HGOTO_ERROR(H5E_VOL, H5E_CANTGET, FAIL, "can't get this type of information");
    } /* end switch */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_file_specific(void* obj, H5VL_file_specific_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    herr_t ret_value = SUCCEED; /* Return value */
    ...
    case H5VL_FILE_IS_EQUAL:
        {
            if (!obj || !args->args.is_equal.obj2) {
                ...
                *args->args.is_equal.same_file = (((H5F_t*)obj)->shared == ((H5F_t*)args->args.is_equal.obj2)->shared);
            }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_file_optional(void* obj, H5VL_optional_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
