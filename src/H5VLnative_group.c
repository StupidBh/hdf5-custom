 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_group_get(void* obj, H5VL_group_get_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    ...
    case H5VL_GROUP_GET_INFO:
        {
            ...
            if (get_info_args->loc_params.type == H5VL_OBJECT_BY_SELF) {
                ...
                /* Retrieve the group's information */
                if (H5G__get_info_by_name(&loc, get_info_args->loc_params.loc_data.loc_by_name.name, get_info_args->ginfo) < 0) {
                    HGOTO_ERROR(H5E_SYM, H5E_CANTGET, FAIL, "can't retrieve group info");
                }
            } /* end else-if */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_group_specific(void* obj, H5VL_group_specific_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    H5G_t* grp = (H5G_t*)obj;
    herr_t ret_value = SUCCEED; /* Return value */
    ...
    case H5VL_GROUP_MOUNT:
        {
            ...
            if (H5F_mount(&loc, args->args.mount.name, args->args.mount.child_file, args->args.mount.fmpl_id) < 0) {
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_group_optional(void H5_ATTR_UNUSED* obj, H5VL_optional_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    ...
    case H5VL_NATIVE_GROUP_ITERATE_OLD:
        {
            ...
            if ((ret_value = H5G_iterate(&grp_loc,
                                         iter_args->loc_params.loc_data.loc_by_name.name,
                                         H5_INDEX_NAME,
                                         H5_ITER_INC,
                                         iter_args->idx,
                                         iter_args->last_obj,
