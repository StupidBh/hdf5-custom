 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_link_create(H5VL_link_create_args_t* args,
                                void* obj,
                                ...
                                void H5_ATTR_UNUSED** req)
{
    ...
    default: HGOTO_ERROR(H5E_LINK, H5E_CANTINIT, FAIL, "invalid link creation call");
    } /* end switch */
                              ...
                              void H5_ATTR_UNUSED** req)
{
    ...
    /* Copy the link */
    if (H5L__move(src_loc_p, loc_params1->loc_data.loc_by_name.name, dst_loc_p, loc_params2->loc_data.loc_by_name.name, true, lcpl_id) < 0) {
                              ...
                              void H5_ATTR_UNUSED** req)
{
    ...
    /* Move the link */
    if (H5L__move(src_loc_p, loc_params1->loc_data.loc_by_name.name, dst_loc_p, loc_params2->loc_data.loc_by_name.name, false, lcpl_id) < 0) {
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_link_get(void* obj, const H5VL_loc_params_t* loc_params, H5VL_link_get_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    H5G_loc_t loc;
    herr_t ret_value = SUCCEED; /* Return value */
    ...
    case H5VL_LINK_GET_NAME:
        {
            if (H5L__get_name_by_idx(&loc,
                                     loc_params->loc_data.loc_by_idx.name,
                                     loc_params->loc_data.loc_by_idx.idx_type,
                                     loc_params->loc_data.loc_by_idx.order,
                                     loc_params->loc_data.loc_by_idx.n,
                                     args->args.get_name.name,
                                     args->args.get_name.name_size,
    ...
    case H5VL_LINK_GET_VAL:
        {
            ...
            if (loc_params->type == H5VL_OBJECT_BY_NAME) {
                ...
                if (H5L__get_val_by_idx(&loc,
                                        loc_params->loc_data.loc_by_idx.name,
                                        loc_params->loc_data.loc_by_idx.idx_type,
                                        loc_params->loc_data.loc_by_idx.order,
                                        loc_params->loc_data.loc_by_idx.n,
                                        args->args.get_val.buf,
    ...
    default: HGOTO_ERROR(H5E_VOL, H5E_CANTGET, FAIL, "can't get this type of information from link");
    } /* end switch */
    ...
    case H5VL_LINK_ITER:
        {
            ...
            if (loc_params->type == H5VL_OBJECT_BY_SELF) {
                if (iter_args->recursive) {
                    /* H5Lvisit */
                    if ((ret_value = H5G_visit(&loc, ".", iter_args->idx_type, iter_args->order, iter_args->op, NULL, iter_args->op_data)) < 0) {
    ...
    case H5VL_LINK_DELETE:
        {
            ...
            if (loc_params->type == H5VL_OBJECT_BY_NAME) { /* H5Ldelete */
                ...
                if (H5L__delete_by_idx(&loc,
                                       loc_params->loc_data.loc_by_idx.name,
                                       loc_params->loc_data.loc_by_idx.idx_type,
                                       loc_params->loc_data.loc_by_idx.order,
                                       loc_params->loc_data.loc_by_idx.n) < 0) {
                    HGOTO_ERROR(H5E_LINK, H5E_CANTDELETE, FAIL, "unable to delete link");
                }
            } /* end else-if */
            else {
