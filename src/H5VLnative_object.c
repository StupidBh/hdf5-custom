...
void* H5VL__native_object_open(void* obj, const H5VL_loc_params_t* loc_params, H5I_type_t* opened_type, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    ...
    case H5VL_OBJECT_BY_IDX:
        {
            /* Open the object */
            if (NULL == (ret_value = H5O__open_by_idx(&loc,
    ...
    default                 : HGOTO_ERROR(H5E_VOL, H5E_UNSUPPORTED, NULL, "unknown open parameters");
    } /* end switch */
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL__native_object_get(void* obj, const H5VL_loc_params_t* loc_params, H5VL_object_get_args_t* args, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED** req)
{
    ...
    default: HGOTO_ERROR(H5E_VOL, H5E_CANTGET, FAIL, "can't get this type of information from object");
    } /* end switch */
                                    ...
                                    void H5_ATTR_UNUSED** req)
{
    ...
    default: HGOTO_ERROR(H5E_VOL, H5E_CANTGET, FAIL, "can't recognize this operation type");
    } /* end switch */
