...
/* src: unsigned, dst: int8_t */
    ...
    #define ASSIGN_unsigned_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: int */
    ...
    #define ASSIGN_unsigned_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: long */
    ...
    #define ASSIGN_unsigned_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: int64_t */
    ...
    #define ASSIGN_unsigned_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: uint8_t */
    ...
    #define ASSIGN_unsigned_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: uint16_t */
    ...
    #define ASSIGN_unsigned_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: uint32_t */
    ...
    #define ASSIGN_unsigned_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: uint64_t */
    ...
    #define ASSIGN_unsigned_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: ptrdiff_t */
    ...
    #define ASSIGN_unsigned_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: size_t */
    ...
    #define ASSIGN_unsigned_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: ssize_t */
    ...
    #define ASSIGN_unsigned_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: haddr_t */
    ...
    #define ASSIGN_unsigned_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: hsize_t */
    ...
    #define ASSIGN_unsigned_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: hssize_t */
    ...
    #define ASSIGN_unsigned_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: unsigned, dst: h5_stat_size_t */
    ...
    #define ASSIGN_unsigned_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_UNSIGNED > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_unsigned_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: unsigned */
    ...
    #define ASSIGN_int8_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: int */
    ...
    #define ASSIGN_int8_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: long */
    ...
    #define ASSIGN_int8_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: int64_t */
    ...
    #define ASSIGN_int8_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: uint8_t */
    ...
    #define ASSIGN_int8_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: uint16_t */
    ...
    #define ASSIGN_int8_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: uint32_t */
    ...
    #define ASSIGN_int8_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: uint64_t */
    ...
    #define ASSIGN_int8_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_int8_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: size_t */
    ...
    #define ASSIGN_int8_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: ssize_t */
    ...
    #define ASSIGN_int8_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: haddr_t */
    ...
    #define ASSIGN_int8_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: hsize_t */
    ...
    #define ASSIGN_int8_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: hssize_t */
    ...
    #define ASSIGN_int8_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int8_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_int8_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_INT8_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_int8_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: int, dst: unsigned */
    ...
    #define ASSIGN_int_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: int8_t */
    ...
    #define ASSIGN_int_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: int64_t */
    ...
    #define ASSIGN_int_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: uint8_t */
    ...
    #define ASSIGN_int_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: uint16_t */
    ...
    #define ASSIGN_int_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: uint32_t */
    ...
    #define ASSIGN_int_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: uint64_t */
    ...
    #define ASSIGN_int_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: ptrdiff_t */
    ...
    #define ASSIGN_int_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: size_t */
    ...
    #define ASSIGN_int_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: ssize_t */
    ...
    #define ASSIGN_int_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: haddr_t */
    ...
    #define ASSIGN_int_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: hsize_t */
    ...
    #define ASSIGN_int_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: hssize_t */
    ...
    #define ASSIGN_int_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int, dst: h5_stat_size_t */
    ...
    #define ASSIGN_int_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: unsigned */
    ...
    #define ASSIGN_long_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: int8_t */
    ...
    #define ASSIGN_long_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: int64_t */
    ...
    #define ASSIGN_long_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: uint8_t */
    ...
    #define ASSIGN_long_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: uint16_t */
    ...
    #define ASSIGN_long_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: uint32_t */
    ...
    #define ASSIGN_long_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: uint64_t */
    ...
    #define ASSIGN_long_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: ptrdiff_t */
    ...
    #define ASSIGN_long_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: size_t */
    ...
    #define ASSIGN_long_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: ssize_t */
    ...
    #define ASSIGN_long_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: haddr_t */
    ...
    #define ASSIGN_long_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: hsize_t */
    ...
    #define ASSIGN_long_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: hssize_t */
    ...
    #define ASSIGN_long_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: long, dst: h5_stat_size_t */
    ...
    #define ASSIGN_long_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: unsigned */
    ...
    #define ASSIGN_int64_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: int8_t */
    ...
    #define ASSIGN_int64_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: int */
    ...
    #define ASSIGN_int64_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: long */
    ...
    #define ASSIGN_int64_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: uint8_t */
    ...
    #define ASSIGN_int64_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: uint16_t */
    ...
    #define ASSIGN_int64_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: uint32_t */
    ...
    #define ASSIGN_int64_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: uint64_t */
    ...
    #define ASSIGN_int64_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_int64_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: size_t */
    ...
    #define ASSIGN_int64_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: ssize_t */
    ...
    #define ASSIGN_int64_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: haddr_t */
    ...
    #define ASSIGN_int64_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: hsize_t */
    ...
    #define ASSIGN_int64_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: hssize_t */
    ...
    #define ASSIGN_int64_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: int64_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_int64_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_INT64_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_int64_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: unsigned */
    ...
    #define ASSIGN_uint8_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: int8_t */
    ...
    #define ASSIGN_uint8_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: int */
    ...
    #define ASSIGN_uint8_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: long */
    ...
    #define ASSIGN_uint8_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: int64_t */
    ...
    #define ASSIGN_uint8_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: uint16_t */
    ...
    #define ASSIGN_uint8_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: uint32_t */
    ...
    #define ASSIGN_uint8_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: uint64_t */
    ...
    #define ASSIGN_uint8_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_uint8_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: size_t */
    ...
    #define ASSIGN_uint8_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: ssize_t */
    ...
    #define ASSIGN_uint8_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: haddr_t */
    ...
    #define ASSIGN_uint8_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: hsize_t */
    ...
    #define ASSIGN_uint8_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: hssize_t */
    ...
    #define ASSIGN_uint8_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint8_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_uint8_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_UINT8_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_uint8_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: unsigned */
    ...
    #define ASSIGN_uint16_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: int8_t */
    ...
    #define ASSIGN_uint16_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: int */
    ...
    #define ASSIGN_uint16_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: long */
    ...
    #define ASSIGN_uint16_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: int64_t */
    ...
    #define ASSIGN_uint16_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: uint8_t */
    ...
    #define ASSIGN_uint16_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: uint32_t */
    ...
    #define ASSIGN_uint16_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: uint64_t */
    ...
    #define ASSIGN_uint16_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_uint16_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: size_t */
    ...
    #define ASSIGN_uint16_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: ssize_t */
    ...
    #define ASSIGN_uint16_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: haddr_t */
    ...
    #define ASSIGN_uint16_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: hsize_t */
    ...
    #define ASSIGN_uint16_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: hssize_t */
    ...
    #define ASSIGN_uint16_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint16_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_uint16_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_UINT16_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_uint16_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: unsigned */
    ...
    #define ASSIGN_uint32_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: int8_t */
    ...
    #define ASSIGN_uint32_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: int */
    ...
    #define ASSIGN_uint32_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: long */
    ...
    #define ASSIGN_uint32_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: int64_t */
    ...
    #define ASSIGN_uint32_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: uint8_t */
    ...
    #define ASSIGN_uint32_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: uint16_t */
    ...
    #define ASSIGN_uint32_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: uint64_t */
    ...
    #define ASSIGN_uint32_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_uint32_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: size_t */
    ...
    #define ASSIGN_uint32_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: ssize_t */
    ...
    #define ASSIGN_uint32_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: haddr_t */
    ...
    #define ASSIGN_uint32_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: hsize_t */
    ...
    #define ASSIGN_uint32_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: hssize_t */
    ...
    #define ASSIGN_uint32_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint32_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_uint32_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_UINT32_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_uint32_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: unsigned */
    ...
    #define ASSIGN_uint64_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: int8_t */
    ...
    #define ASSIGN_uint64_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: int */
    ...
    #define ASSIGN_uint64_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: long */
    ...
    #define ASSIGN_uint64_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: int64_t */
    ...
    #define ASSIGN_uint64_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: uint8_t */
    ...
    #define ASSIGN_uint64_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: uint16_t */
    ...
    #define ASSIGN_uint64_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: uint32_t */
    ...
    #define ASSIGN_uint64_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_uint64_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: size_t */
    ...
    #define ASSIGN_uint64_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: ssize_t */
    ...
    #define ASSIGN_uint64_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: haddr_t */
    ...
    #define ASSIGN_uint64_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: hsize_t */
    ...
    #define ASSIGN_uint64_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: hssize_t */
    ...
    #define ASSIGN_uint64_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: uint64_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_uint64_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_UINT64_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_uint64_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: unsigned */
    ...
    #define ASSIGN_ptrdiff_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: int8_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: int */
    ...
    #define ASSIGN_ptrdiff_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: long */
    ...
    #define ASSIGN_ptrdiff_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: int64_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: uint8_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: uint16_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: uint32_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: uint64_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: size_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: ssize_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: haddr_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: hsize_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: hssize_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ptrdiff_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_ptrdiff_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_PTRDIFF_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_ptrdiff_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: size_t, dst: unsigned */
    ...
    #define ASSIGN_size_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: int8_t */
    ...
    #define ASSIGN_size_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: int */
    ...
    #define ASSIGN_size_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: long */
    ...
    #define ASSIGN_size_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: int64_t */
    ...
    #define ASSIGN_size_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: uint8_t */
    ...
    #define ASSIGN_size_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: uint16_t */
    ...
    #define ASSIGN_size_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: uint32_t */
    ...
    #define ASSIGN_size_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: uint64_t */
    ...
    #define ASSIGN_size_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_size_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: ssize_t */
    ...
    #define ASSIGN_size_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: haddr_t */
    ...
    #define ASSIGN_size_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: hsize_t */
    ...
    #define ASSIGN_size_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: hssize_t */
    ...
    #define ASSIGN_size_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: size_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_size_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_SIZE_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_size_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: unsigned */
    ...
    #define ASSIGN_ssize_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: int8_t */
    ...
    #define ASSIGN_ssize_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: int */
    ...
    #define ASSIGN_ssize_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: long */
    ...
    #define ASSIGN_ssize_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: int64_t */
    ...
    #define ASSIGN_ssize_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: uint8_t */
    ...
    #define ASSIGN_ssize_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: uint16_t */
    ...
    #define ASSIGN_ssize_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: uint32_t */
    ...
    #define ASSIGN_ssize_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: uint64_t */
    ...
    #define ASSIGN_ssize_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_ssize_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: size_t */
    ...
    #define ASSIGN_ssize_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: haddr_t */
    ...
    #define ASSIGN_ssize_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: hsize_t */
    ...
    #define ASSIGN_ssize_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: hssize_t */
    ...
    #define ASSIGN_ssize_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: ssize_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_ssize_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_SSIZE_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_ssize_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: unsigned */
    ...
    #define ASSIGN_haddr_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: int8_t */
    ...
    #define ASSIGN_haddr_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: int */
    ...
    #define ASSIGN_haddr_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: long */
    ...
    #define ASSIGN_haddr_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: int64_t */
    ...
    #define ASSIGN_haddr_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: uint8_t */
    ...
    #define ASSIGN_haddr_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: uint16_t */
    ...
    #define ASSIGN_haddr_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: uint32_t */
    ...
    #define ASSIGN_haddr_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: uint64_t */
    ...
    #define ASSIGN_haddr_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_haddr_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: size_t */
    ...
    #define ASSIGN_haddr_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: ssize_t */
    ...
    #define ASSIGN_haddr_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: hsize_t */
    ...
    #define ASSIGN_haddr_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: hssize_t */
    ...
    #define ASSIGN_haddr_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: haddr_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_haddr_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_HADDR_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_haddr_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: unsigned */
    ...
    #define ASSIGN_hsize_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: int8_t */
    ...
    #define ASSIGN_hsize_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: int */
    ...
    #define ASSIGN_hsize_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: long */
    ...
    #define ASSIGN_hsize_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: int64_t */
    ...
    #define ASSIGN_hsize_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: uint8_t */
    ...
    #define ASSIGN_hsize_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: uint16_t */
    ...
    #define ASSIGN_hsize_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: uint32_t */
    ...
    #define ASSIGN_hsize_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: uint64_t */
    ...
    #define ASSIGN_hsize_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_hsize_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: size_t */
    ...
    #define ASSIGN_hsize_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: ssize_t */
    ...
    #define ASSIGN_hsize_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: haddr_t */
    ...
    #define ASSIGN_hsize_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: hssize_t */
    ...
    #define ASSIGN_hsize_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: hsize_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_hsize_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_HSIZE_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_hsize_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: unsigned */
    ...
    #define ASSIGN_hssize_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: int8_t */
    ...
    #define ASSIGN_hssize_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: int */
    ...
    #define ASSIGN_hssize_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: long */
    ...
    #define ASSIGN_hssize_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: int64_t */
    ...
    #define ASSIGN_hssize_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: uint8_t */
    ...
    #define ASSIGN_hssize_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: uint16_t */
    ...
    #define ASSIGN_hssize_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: uint32_t */
    ...
    #define ASSIGN_hssize_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: uint64_t */
    ...
    #define ASSIGN_hssize_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_hssize_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: size_t */
    ...
    #define ASSIGN_hssize_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: ssize_t */
    ...
    #define ASSIGN_hssize_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: haddr_t */
    ...
    #define ASSIGN_hssize_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: hsize_t */
    ...
    #define ASSIGN_hssize_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
...
/* src: hssize_t, dst: h5_stat_size_t */
    ...
    #define ASSIGN_hssize_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SIGNED_TO_UNSIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_HSSIZE_T > H5_SIZEOF_H5_STAT_SIZE_T
    #define ASSIGN_hssize_t_TO_h5_stat_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: unsigned */
    ...
    #define ASSIGN_h5_stat_size_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_UNSIGNED
    #define ASSIGN_h5_stat_size_t_TO_unsigned(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: int8_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_INT8_T
    #define ASSIGN_h5_stat_size_t_TO_int8_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: int */
    ...
    #define ASSIGN_h5_stat_size_t_TO_int(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: long */
    ...
    #define ASSIGN_h5_stat_size_t_TO_long(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: int64_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_INT64_T
    #define ASSIGN_h5_stat_size_t_TO_int64_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: uint8_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_UINT8_T
    #define ASSIGN_h5_stat_size_t_TO_uint8_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: uint16_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_UINT16_T
    #define ASSIGN_h5_stat_size_t_TO_uint16_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: uint32_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_UINT32_T
    #define ASSIGN_h5_stat_size_t_TO_uint32_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: uint64_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_UINT64_T
    #define ASSIGN_h5_stat_size_t_TO_uint64_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: ptrdiff_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_PTRDIFF_T
    #define ASSIGN_h5_stat_size_t_TO_ptrdiff_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: size_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_SIZE_T
    #define ASSIGN_h5_stat_size_t_TO_size_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: ssize_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_SSIZE_T
    #define ASSIGN_h5_stat_size_t_TO_ssize_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: haddr_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_HADDR_T
    #define ASSIGN_h5_stat_size_t_TO_haddr_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: hsize_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_SAME_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_HSIZE_T
    #define ASSIGN_h5_stat_size_t_TO_hsize_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
...
/* src: h5_stat_size_t, dst: hssize_t */
    ...
    #define ASSIGN_h5_stat_size_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_LARGER_SIZE_UNSIGNED_TO_SIGNED(dst, dsttype, src, srctype)
#elif H5_SIZEOF_H5_STAT_SIZE_T > H5_SIZEOF_HSSIZE_T
    #define ASSIGN_h5_stat_size_t_TO_hssize_t(dst, dsttype, src, srctype) ASSIGN_TO_SMALLER_SIZE(dst, dsttype, src, srctype)
