 ...
 *
 * This header is also included by project-owned C++ test
 * infrastructure, so this typedef creation must be avoided
 * when __cplusplus is defined. Some C++ compilers do not
 * provide a _Float16 type or require an additional flag.
 */
