...
static void print_async_test_header(void H5_ATTR_UNUSED* params)
{
    printf("\n");
    printf("**********************************************\n");
    printf("*                                            *\n");
 ...
 */
static void test_one_dataset_io(void H5_ATTR_UNUSED* params)
{
 ...
 */
static void test_multi_dataset_io(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
 ...
 * from them
 */
static void test_multi_file_dataset_io(void H5_ATTR_UNUSED* params)
{
 ...
 * and read from them
 */
static void test_multi_file_grp_dset_io(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
 ...
 * Create file and dataset, write to dataset
 */
static void test_set_extent(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
    hid_t dset_id = H5I_INVALID_HID;
    hid_t fspace_id[6] = { H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID };
    hid_t fspace_out[6] = { H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID, H5I_INVALID_HID };
    ...
    if (!(vol_cap_flags_g & H5VL_CAP_FLAG_ASYNC) || !(vol_cap_flags_g & H5VL_CAP_FLAG_FILE_BASIC) || !(vol_cap_flags_g & H5VL_CAP_FLAG_FLUSH_REFRESH) ||
        ...
        SKIPPED();
        printf(
            "    API functions for basic file, dataset, dataset more, or flush aren't supported with "
            "this connector\n");
        return;
    }
    ...
    /* Create the dataset asynchronously */
    if ((dset_id = H5Dcreate_async(file_id, "dset", H5T_NATIVE_INT, fspace_id[0], H5P_DEFAULT, dcpl_id, H5P_DEFAULT, es_id)) < 0) {
        TEST_ERROR;
    }
 ...
 */
static void test_attribute_io(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
    hid_t dset_id = H5I_INVALID_HID;
    hid_t attr_id = H5I_INVALID_HID;
 ...
 */
static void test_attribute_io_tconv(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
    hid_t attr_id = H5I_INVALID_HID;
    hid_t space_id = H5I_INVALID_HID;
...
static void test_attribute_io_compound(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
    hid_t attr_id = H5I_INVALID_HID;
    hid_t space_id = H5I_INVALID_HID;
 ...
 */
static void test_group(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
    ...
    if (!(vol_cap_flags_g & H5VL_CAP_FLAG_ASYNC) || !(vol_cap_flags_g & H5VL_CAP_FLAG_FILE_BASIC) || !(vol_cap_flags_g & H5VL_CAP_FLAG_GROUP_BASIC) ||
        ...
        SKIPPED();
        printf(
            "    API functions for basic file, group, or group more aren't supported "
            "with this connector\n");
        return;
    }
 ...
 */
static void test_link(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
    hid_t parent_group_id = H5I_INVALID_HID;
    hid_t group_id = H5I_INVALID_HID;
 ...
 */
static void test_ocopy_orefresh(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
    hid_t parent_group_id = H5I_INVALID_HID;
    hid_t dset_id = H5I_INVALID_HID;
    ...
    if (!(vol_cap_flags_g & H5VL_CAP_FLAG_ASYNC) || !(vol_cap_flags_g & H5VL_CAP_FLAG_FILE_BASIC) || !(vol_cap_flags_g & H5VL_CAP_FLAG_GROUP_BASIC) ||
        ...
        SKIPPED();
        printf(
            "    API functions for basic file, group, dataset, object more, flush, or refresh aren't "
            "supported with this connector\n");
        return;
    }
 ...
 * Test H5Freopen()
 */
static void test_file_reopen(void H5_ATTR_UNUSED* params)
{
    hid_t file_id = H5I_INVALID_HID;
 ...
 */
static void test_file_cleanup(void H5_ATTR_UNUSED* params)
{
    char file_name[64];
    int i;
...
void H5_api_async_test_add(void)
{
    ...
    AddTest("test_multi_file_dataset_io", test_multi_file_dataset_io, NULL, NULL, NULL, 0, "multi file dataset I/O");
    AddTest("test_multi_file_grp_dset_io", test_multi_file_grp_dset_io, NULL, NULL, NULL, 0, "multi file dataset I/O with groups");
    ...
    AddTest("test_attribute_io_tconv", test_attribute_io_tconv, NULL, NULL, NULL, 0, "attribute I/O with type conversion");
    AddTest("test_attribute_io_compound", test_attribute_io_compound, NULL, NULL, NULL, 0, "attribute I/O with compound type conversion");
