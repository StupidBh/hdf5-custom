...
static bool check_fapl_mdc_api_calls(unsigned paged, hid_t fcpl_id)
{
    ...
    H5AC_cache_config_t mod_config = { /* int         version                = */ H5AC__CURR_CACHE_CONFIG_VERSION,
...
static bool check_file_mdc_api_calls(unsigned paged, hid_t fcpl_id)
{
    ...
    double hit_rate;
    H5AC_cache_config_t default_config = H5AC__DEFAULT_CACHE_CONFIG;
    H5AC_cache_config_t mod_config_1 = { /* int         version                = */ H5C__CURR_AUTO_SIZE_CTL_VER,
                                         /* bool     rpt_fcn_enabled        = */ false,
                                         /* bool     open_trace_file        = */ false,
                                         /* bool     close_trace_file       = */ false,
                                         /* char        trace_file_name[]      = */ "",
                                         ...
                                         /* int        metadata_write_strategy = */
                                         H5AC__DEFAULT_METADATA_WRITE_STRATEGY };
    H5AC_cache_config_t mod_config_2 = { /* int         version                = */ H5C__CURR_AUTO_SIZE_CTL_VER,
                                         ...
                                         /* int        metadata_write_strategy = */
                                         H5AC__DEFAULT_METADATA_WRITE_STRATEGY };
    H5AC_cache_config_t mod_config_3 = { /* int         version                = */ H5C__CURR_AUTO_SIZE_CTL_VER,
                                         /* bool     rpt_fcn_enabled        = */ false,
                                         /* bool     open_trace_file        = */ false,
                                         /* bool     close_trace_file       = */ false,
                                         /* char        trace_file_name[]      = */ "",
                                         ...
                                         /* int        metadata_write_strategy = */
                                         H5AC__DEFAULT_METADATA_WRITE_STRATEGY };
    H5AC_cache_config_t mod_config_4 = { /* int         version                = */ H5C__CURR_AUTO_SIZE_CTL_VER,
                                         /* bool     rpt_fcn_enabled        = */ false,
                                         /* bool     open_trace_file        = */ false,
                                         /* bool     close_trace_file       = */ false,
                                         /* char        trace_file_name[]      = */ "",
    ...
    if (pass) {
        ...
        else if ((mod_config_4.initial_size != max_size) || (min_clean_size != (size_t)((double)max_size * mod_config_4.min_clean_fraction))) {
            pass = false;
...
static bool mdc_api_call_smoke_check(int express_test, unsigned paged, hid_t fcpl_id)
{
    ...
    H5AC_cache_config_t mod_config_1 = { /* int         version                = */ H5C__CURR_AUTO_SIZE_CTL_VER,
                                         ...
                                         /* size_t      max_increment          = */ 4'000'000,
                                         /* enum H5C_cache_flash_incr_mode       */
                                         /*                    flash_incr_mode = */ H5C_flash_incr__off,
                                         /* double      flash_multiple         = */ 2.0,
                                         /* double      flash_threshold        = */ 0.5,
                                         ...
                                         /* double      decrement              = */ 0.9,
                                         /* bool     apply_max_decrement    = */ false,
                                         /* size_t      max_decrement          = */ 1'000'000,
    ...
    H5AC_cache_config_t mod_config_2 = { /* int         version                = */ H5C__CURR_AUTO_SIZE_CTL_VER,
                                         ...
                                         /* bool     evictions_enabled      = */ true,
                                         /* bool     set_initial_size       = */ true,
                                         /* size_t      initial_size           = */ 12'000'000,
                                         /* double      min_clean_fraction     = */ 0.1,
                                         /* size_t      max_size               = */ 16'000'000,
                                         /* size_t      min_size               = */ 250000,
                                         /* long int    epoch_length           = */ 50000,
...
static bool check_fapl_mdc_api_errs(void)
{
    ...
    scratch.version = H5C__CURR_AUTO_SIZE_CTL_VER;
    if ((pass) && ((H5Pget_mdc_config(fapl_id, &scratch) < 0) || (!CACHE_CONFIGS_EQUAL(default_config, scratch, true, true)))) {
        pass = false;
...
static bool check_file_mdc_api_errs(unsigned paged, hid_t fcpl_id)
{
    ...
    if (pass) {
        ...
        H5E_BEGIN_TRY
        {
            result = H5Fget_mdc_size((hid_t)H5I_INVALID_HID, &max_size, &min_clean_size, &cur_size, &cur_num_entries);
        }
        H5E_END_TRY
    ...
    if (pass) {
        ...
        if ((H5Fget_mdc_size(file_id, &max_size, NULL, NULL, NULL) < 0) || (H5Fget_mdc_size(file_id, NULL, &min_clean_size, NULL, NULL) < 0) ||
            (H5Fget_mdc_size(file_id, NULL, NULL, &cur_size, NULL) < 0) || (H5Fget_mdc_size(file_id, NULL, NULL, NULL, &cur_num_entries) < 0) ||
