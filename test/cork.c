...
static unsigned test_objs_cork(bool swmr, bool new_format)
{
    ...
    if (new_format) {
        if (swmr) {
            TESTING(
                "H5Odisable_mdc_flushes/H5Oenable_mdc_flushes/H5Oare_mdc_flushes_disabled (new library "
                "format) (SWMR)");
        } /* end if */
        else {
            TESTING(
        ...
        if (swmr) {
            TESTING(
                "H5Odisable_mdc_flushes/H5Oenable_mdc_flushes/H5Oare_mdc_flushes_disabled (old library "
                "format) (SWMR)");
        } /* end if */
        else {
            TESTING(
...
static unsigned test_dset_cork(bool swmr, bool new_format)
{
    ...
    if (new_format) {
        if (swmr) {
            TESTING(
                "H5Odisable_mdc_flushes/H5Oenable_mdc_flushes/H5Oare_mdc_flushes_disabled on datasets "
