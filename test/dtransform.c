...
const float windchillFfloat[ROWS][COLS] = {
    ...
    { 25.0F, 17.0F, 10.0F, 3.0F, -4.0F, -11.0F, -19.0F, -26.0F, -33.0F, -40.0F, -48.0F, -55.0F, -62.0F, -69.0F, -76.0F, -84.0F, -91.0F, -97.0F }
};

const int transformData[ROWS][COLS] = {
    { 36, 31, 25, 19, 13, 7, 1, 5, 11, 16, 22, 28, 34, 40, 46, 52, 57, 63 }, { 34, 27, 21, 15, 9, 3, 4, 10, 16, 22, 28, 35, 41, 47, 53, 59, 66, 1 },
    { 32, 25, 19, 13, 6, 2, 7, 13, 19, 26, 32, 39, 45, 51, 58, 64, 71, 5 },  { 30, 24, 17, 11, 4, 2, 9, 15, 22, 29, 35, 42, 48, 55, 61, 68, 2, 9 },
    { 29, 23, 16, 9, 3, 4, 11, 17, 24, 31, 37, 44, 51, 58, 64, 71, 6, 12 },  { 28, 22, 15, 8, 1, 5, 12, 19, 26, 33, 39, 46, 53, 60, 67, 1, 8, 15 },
    { 28, 21, 14, 7, 6, 7, 14, 21, 27, 34, 41, 48, 55, 62, 69, 4, 10, 17 },  { 27, 20, 13, 6, 1, 8, 15, 22, 29, 36, 43, 50, 57, 64, 71, 6, 12, 19 },
    { 26, 19, 12, 5, 2, 9, 16, 23, 30, 37, 44, 51, 58, 65, 5, 7, 14, 21 },   { 26, 19, 12, 4, 3, 10, 17, 24, 31, 38, 45, 52, 60, 67, 2, 9, 16, 23 },
    { 25, 18, 11, 4, 3, 11, 18, 25, 32, 39, 46, 54, 61, 68, 3, 10, 17, 25 }, { 25, 17, 10, 3, 4, 11, 19, 26, 33, 40, 48, 55, 62, 69, 4, 12, 19, 26 }
};
...
#define UCOMPARE(TYPE, VAR1, VAR2, TOL)                                                                               \
    do {                                                                                                              \
        ...
        for (i = 0; i < ROWS; i++)                                                                                    \
            for (j = 0; j < COLS; j++) {                                                                              \
                if (!((((VAR1)[i][j] >= (TYPE)((VAR2)[i][j])) && (((VAR1)[i][j] - (TOL)) < (TYPE)((VAR2)[i][j]))) ||  \
                      (((VAR1)[i][j] <= (TYPE)((VAR2)[i][j])) && (((VAR1)[i][j] + (TOL)) > (TYPE)((VAR2)[i][j]))))) { \
                    H5_FAILED();                                                                                      \
...
#define TEST_TYPE_CONTIG(XFORM, TYPE, HDF_TYPE, TEST_STR, COMPARE_DATA, SIGNED)                                                                 \
    do {                                                                                                                                        \
        ...
        if ((dataspace = H5Screate_simple(2, dim, NULL)) < 0)                                                                                   \
            TEST_ERROR;                                                                                                                         \
        if ((dset = H5Dcreate2(file_id, "/transformtest_" TEST_STR, HDF_TYPE, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0)           \
            TEST_ERROR;                                                                                                                         \
                                                                                                                                                \
        ...
        if (H5Tset_order(dt_nn, order == H5T_ORDER_LE ? H5T_ORDER_BE : H5T_ORDER_LE) < 0)                                                       \
            TEST_ERROR;                                                                                                                         \
        if ((dset_nn = H5Dcreate2(file_id, "/nonnative_transformtest_" TEST_STR, dt_nn, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) \
            TEST_ERROR;                                                                                                                         \
        if (H5Tclose(dt_nn) < 0)                                                                                                                \
            TEST_ERROR;                                                                                                                         \
                                                                                                                                                \
...
#define TEST_TYPE_CHUNK(XFORM, TYPE, HDF_TYPE, TEST_STR, COMPARE_DATA, SIGNED)                                                               \
    do {                                                                                                                                     \
        ...
        if (H5Pset_chunk(cparms, 2, dim) < 0)                                                                                                \
            TEST_ERROR;                                                                                                                      \
                                                                                                                                             \
        if ((dset_chunk = H5Dcreate2(file_id, "/transformtest_chunk_" TEST_STR, HDF_TYPE, dataspace, H5P_DEFAULT, cparms, H5P_DEFAULT)) < 0) \
            TEST_ERROR;                                                                                                                      \
        ...
        if (SIGNED) {                                                                                                                        \
            ...
            if (H5Pset_data_transform(dxpl_id_f_to_c, f_to_c) < 0)                                                                           \
                TEST_ERROR;                                                                                                                  \
            if (H5Dwrite(dset_chunk, H5T_NATIVE_FLOAT, dataspace, filespace, dxpl_id_f_to_c, windchillFfloat) < 0)                           \
                TEST_ERROR;                                                                                                                  \
            if (H5Pclose(dxpl_id_f_to_c) < 0)                                                                                                \
                TEST_ERROR;                                                                                                                  \
        }                                                                                                                                    \
            ...
            if (H5Pset_data_transform(dxpl_id_utrans, utrans) < 0)                                                                           \
                TEST_ERROR;                                                                                                                  \
            if (H5Dwrite(dset_chunk, H5T_NATIVE_INT, dataspace, filespace, dxpl_id_utrans, transformData) < 0)                               \
                TEST_ERROR;                                                                                                                  \
            if (H5Pclose(dxpl_id_utrans) < 0)                                                                                                \
                TEST_ERROR;                                                                                                                  \
        }                                                                                                                                    \
...
static int init_test(hid_t file_id)
{
    ...
    if ((dset_id_int = H5Dcreate2(file_id, "/default_int", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((dset_id_float = H5Dcreate2(file_id, "/default_float", H5T_NATIVE_FLOAT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((dset_id_int_chunk = H5Dcreate2(file_id, "/default_chunk_int", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, cparms, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if (H5Dwrite(dset_id_int_chunk, H5T_NATIVE_FLOAT, dataspace, filespace, dxpl_id_f_to_c, windchillFfloat) < 0) {
        TEST_ERROR;
    }

    if ((dset_id_float_chunk = H5Dcreate2(file_id, "/default_chunk_float", H5T_NATIVE_FLOAT, dataspace, H5P_DEFAULT, cparms, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(dset_id_float_chunk, H5T_NATIVE_FLOAT, dataspace, filespace, dxpl_id_f_to_c, windchillFfloat) < 0) {
        TEST_ERROR;
    }
...
static int test_specials(hid_t file)
{
    ...
    if ((dset_id = H5Dcreate2(file, "/special1", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((dset_id = H5Dcreate2(file, "/special2", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id, transformData) < 0) {
        TEST_ERROR;
    ...
    if ((dset_id = H5Dcreate2(file, "/special3", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id, transformData) < 0) {
        TEST_ERROR;
    ...
    if ((dset_id = H5Dcreate2(file, "/special4", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id, transformData) < 0) {
        TEST_ERROR;
    ...
    if ((dset_id = H5Dcreate2(file, "/special5", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id, transformData) < 0) {
        TEST_ERROR;
    ...
    if ((dset_id = H5Dcreate2(file, "/special6", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id, transformData) < 0) {
        TEST_ERROR;
    ...
    if ((dset_id = H5Dcreate2(file, "/special7", H5T_NATIVE_INT, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, dxpl_id, transformData) < 0) {
        TEST_ERROR;
...
static int test_getset(const hid_t dxpl_id_c_to_f)
{
    int row;
    int col;
    float windchillFfloatread[ROWS][COLS];
