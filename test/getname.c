...
static int check_name(hid_t id, const char* chk_name, const char* chk_user_path)
{
...
static int test_main(hid_t file_id, hid_t fapl)
{
    char filename1[1024];
    char filename2[1024];
    char filename3[1024];
    ...
    if ((dataset_id = H5Dcreate2(file_id, "d1", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((dataset_id = H5Dcreate2(group_id, "d1", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        FAIL_STACK_ERROR;
    }
    ...
    if ((dataset_id = H5Dcreate2(group3_id, "d1", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((dataset_id = H5Dcreate2(group_id, "d", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        FAIL_STACK_ERROR;
    }
    if ((dataset2_id = H5Dcreate2(group2_id, "d", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        FAIL_STACK_ERROR;
    }
    ...
    /* Create the dataset */
    if ((dataset_id = H5Dcreate2(file1_id, "d", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* Create a new dataset */
    if ((dataset_id = H5Dcreate2(group_id, "d", type_id, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        FAIL_STACK_ERROR;
    }
    ...
    /* Create a new dataset */
    if ((dataset_id = H5Dcreate2(file2_id, "d", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        FAIL_STACK_ERROR;
    }

    /* Create a new dataset */
    if ((dataset2_id = H5Dcreate2(file3_id, "d", H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        FAIL_STACK_ERROR;
    }
    ...
    /* Create a new dataset */
    if ((dataset_id = H5Dcreate2(file_id, "d2", type_id, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((dataset_id = H5Dcreate2(file_id, "g18/d2", type_id, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        FAIL_STACK_ERROR;
    }
...
static int test_obj_ref(hid_t fapl)
{
    char filename1[1024];
    char filename2[1024];
...
static int test_reg_ref(hid_t fapl)
{
    char filename1[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_elinks(hid_t fapl)
{
