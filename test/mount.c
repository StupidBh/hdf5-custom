 ...
 *-------------------------------------------------------------------------
 */
static int test_basic(hid_t fapl)
{
    ...
    if ((file1 = H5Fopen(filename1, H5F_ACC_RDONLY, fapl)) < 0 || (file2 = H5Fopen(filename2, H5F_ACC_RDONLY, fapl)) < 0) {
        FAIL_STACK_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_illegal(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file1b = H5I_INVALID_HID, file2 = H5I_INVALID_HID, file3 = H5I_INVALID_HID, file3b = H5I_INVALID_HID, mnt = H5I_INVALID_HID;
 ...
 *-------------------------------------------------------------------------
 */
static int test_samefile(hid_t fapl)
{
    hid_t file1a = H5I_INVALID_HID, file1b = H5I_INVALID_HID, file2 = H5I_INVALID_HID, file3 = H5I_INVALID_HID;
 ...
 *-------------------------------------------------------------------------
 */
static int test_hide(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID, grp = H5I_INVALID_HID;
    H5O_info2_t oi1, oi2;
    char filename1[1024], filename2[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_assoc(hid_t fapl)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_mntlnk(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID, grp = H5I_INVALID_HID;
    char filename1[1024], filename2[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_move(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID;
    herr_t status;
    char filename1[1024], filename2[1024];
    ...
    /* Build the virtual file */
    if ((file1 = H5Fopen(filename1, H5F_ACC_RDWR, fapl)) < 0 || (file2 = H5Fopen(filename2, H5F_ACC_RDWR, fapl)) < 0) {
        FAIL_STACK_ERROR;
    }
    if (H5Fmount(file1, "/mnt1", file2, H5P_DEFAULT) < 0) {
        FAIL_STACK_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static int test_preopen(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID, grp = H5I_INVALID_HID;
    H5O_info2_t oinfo;
    char filename1[1024], filename2[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_postopen(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID, grp = H5I_INVALID_HID;
    H5O_info2_t oinfo;
    char filename1[1024], filename2[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_unlink(hid_t fapl)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_mvmpt(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID;
    H5O_info2_t oinfo;
    char filename1[1024], filename2[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_interlink(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID;
#ifdef NOT_NOW
 ...
 *-------------------------------------------------------------------------
 */
static int test_uniformity(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID;
    H5O_info2_t oinfo;
    char filename1[1024], filename2[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_close(hid_t fapl)
{
    hid_t file1 = H5I_INVALID_HID, file2 = H5I_INVALID_HID;
    H5O_info2_t oinfo;
    char filename1[1024], filename2[1024];
 ...
 *-------------------------------------------------------------------------
 */
static int test_mount_after_close(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID;                                                                             /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidAB = H5I_INVALID_HID, gidABM = H5I_INVALID_HID, gidX = H5I_INVALID_HID, gidXY = H5I_INVALID_HID; /* Group identifiers */
    hid_t gidABMX = H5I_INVALID_HID, gidABC = H5I_INVALID_HID, gidABT = H5I_INVALID_HID;                                              /* Group IDs for testing */
 ...
 *-------------------------------------------------------------------------
 */
static int test_mount_after_unmount(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID, fid3 = H5I_INVALID_HID, fid4 = H5I_INVALID_HID;                         /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidB = H5I_INVALID_HID, gidX = H5I_INVALID_HID, gidY = H5I_INVALID_HID, gidZ = H5I_INVALID_HID; /* Group identifiers */
 ...
 *-------------------------------------------------------------------------
 */
static int test_missing_unmount(hid_t fapl)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_hold_open_file(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID;                          /* File IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_hold_open_group(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID;                                                                           /* File IDs */
    hid_t gid = H5I_INVALID_HID, gidA = H5I_INVALID_HID, gidM = H5I_INVALID_HID, gidAM = H5I_INVALID_HID, gidAM2 = H5I_INVALID_HID; /* Group IDs */
    char filename1[1024], filename2[1024];                                                                                          /* Name of files to mount */
 ...
 *-------------------------------------------------------------------------
 */
static int test_fcdegree_same(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID;                          /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidM = H5I_INVALID_HID, gidAM = H5I_INVALID_HID; /* Group IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_fcdegree_semi(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID;                          /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidM = H5I_INVALID_HID, gidAM = H5I_INVALID_HID; /* Group IDs */
    hid_t fapl_id = H5I_INVALID_HID;                                               /* FAPL IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_fcdegree_strong(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID;                          /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidM = H5I_INVALID_HID, gidAM = H5I_INVALID_HID; /* Group IDs */
    hid_t fapl_id = H5I_INVALID_HID;                                               /* FAPL IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_acc_perm(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID, fid3 = H5I_INVALID_HID; /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidB = H5I_INVALID_HID, gidC = H5I_INVALID_HID, gidM = H5I_INVALID_HID, gidAM = H5I_INVALID_HID,
          gidAMZ = H5I_INVALID_HID;                                               /* Group IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_mult_mount(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID, fid3 = H5I_INVALID_HID, fid3_2 = H5I_INVALID_HID;                          /* File IDs */
    ...
    hid_t gidS = H5I_INVALID_HID, gidT = H5I_INVALID_HID, gidU = H5I_INVALID_HID, gidBS = H5I_INVALID_HID, gidAMT = H5I_INVALID_HID; /* Group IDs in file #3 */
    char name[NAME_BUF_SIZE];                               /* Buffer for filename retrieved */
    char filename1[1024], filename2[1024], filename3[1024]; /* Name of files to mount */
 ...
 *-------------------------------------------------------------------------
 */
static int test_nested_survive(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID, fid3 = H5I_INVALID_HID;    /* File IDs */
    hid_t gidA = H5I_INVALID_HID;                                                    /* Group IDs in file #1 */
    hid_t gidM = H5I_INVALID_HID, gidAM = H5I_INVALID_HID;                           /* Group IDs in file #2 */
    hid_t gidS = H5I_INVALID_HID, gidMS = H5I_INVALID_HID, gidAMS = H5I_INVALID_HID; /* Group IDs in file #3 */
    char name[NAME_BUF_SIZE];                                                        /* Buffer for filename retrieved */
 ...
 *-------------------------------------------------------------------------
 */
static int test_close_parent(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID; /* File IDs */
    hid_t gidA = H5I_INVALID_HID;                         /* Group IDs in file #1 */
 ...
 *-------------------------------------------------------------------------
 */
static int test_cut_graph(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID, fid3 = H5I_INVALID_HID, fid4 = H5I_INVALID_HID, fid5 = H5I_INVALID_HID, fid6 = H5I_INVALID_HID,
          fid7 = H5I_INVALID_HID;                         /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidB = H5I_INVALID_HID; /* Group IDs in file #1 */
    ...
    char filename1[NAME_BUF_SIZE], filename2[NAME_BUF_SIZE], filename3[NAME_BUF_SIZE], filename4[NAME_BUF_SIZE], filename5[NAME_BUF_SIZE], filename6[NAME_BUF_SIZE],
 ...
 *-------------------------------------------------------------------------
 */
static int test_symlink(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID, fid3 = H5I_INVALID_HID;      /* File IDs */
    hid_t gidA = H5I_INVALID_HID, gidB = H5I_INVALID_HID;                              /* Group IDs in file #1 */
    hid_t gidD = H5I_INVALID_HID, gidE = H5I_INVALID_HID;                              /* Group IDs in file #2 */
    ...
    char name[NAME_BUF_SIZE];                                                          /* Buffer for filename retrieved */
    ssize_t name_len;                                                                  /* Filename length */
    char filename1[NAME_BUF_SIZE], filename2[NAME_BUF_SIZE], filename3[NAME_BUF_SIZE]; /* Name of files to mount */
 ...
 *-------------------------------------------------------------------------
 */
static int test_sharedacc(hid_t fapl)
{
    hid_t fid1[2] = { H5I_INVALID_HID, H5I_INVALID_HID }, fid2[2] = { H5I_INVALID_HID, H5I_INVALID_HID }; /* File IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_sharedclose(hid_t fapl)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_multisharedclose(hid_t fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID;                                                        /* File IDs */
    hid_t gid1 = H5I_INVALID_HID, gid2 = H5I_INVALID_HID, gid3 = H5I_INVALID_HID;
    char filename1[NAME_BUF_SIZE], filename2[NAME_BUF_SIZE], filename3[NAME_BUF_SIZE], filename4[NAME_BUF_SIZE]; /* Name of files to mount */
