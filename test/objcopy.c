...
static const char* FILENAME[] = { "objcopy_src", "objcopy_dst", "objcopy_ext", "objcopy_src2", "verbound_src", "verbound_dst", NULL };
...
static int compare_data(hid_t parent1, hid_t parent2, hid_t pid, hid_t tid, size_t nelmts, const void* buf1, const void* buf2, hid_t obj_owner);
 ...
 *-------------------------------------------------------------------------
 */
static void token_insert(H5O_info2_t* oi)
{
    size_t n;
 ...
 *-------------------------------------------------------------------------
 */
static H5_ATTR_PURE bool token_lookup(hid_t loc_id, H5O_info2_t* oi)
{
    size_t n;
    int token_cmp;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t attach_ref_attr(hid_t file_id, hid_t loc_id)
{
    char dsetname1[] = "dataset1_pointed_by_ref_attr";
    char dsetname2[] = "dataset2_pointed_by_ref_attr";
    hid_t did1 = (H5I_INVALID_HID), did2 = (H5I_INVALID_HID), aid = (H5I_INVALID_HID), sid = (H5I_INVALID_HID), sid_ref = (H5I_INVALID_HID);
    hsize_t dims[2] = { 2, 9 };
    ...
    if ((did1 = H5Dcreate2(file_id, dsetname1, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(did1, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, data1) < 0) {
        TEST_ERROR;
    }
    if ((did2 = H5Dcreate2(file_id, dsetname2, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static herr_t attach_reg_ref_attr(hid_t file_id, hid_t loc_id)
{
    ...
    if ((dsetv_id = H5Dcreate2(file_id, dsetnamev, H5T_NATIVE_INT, space_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((aid = H5Acreate2(loc_id, "reg_ref_attr", H5T_STD_REF_DSETREG, spacer_id, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((aid = H5Acreate2(dsetv_id, "reg_ref_attr", H5T_STD_REF_DSETREG, spacer_id, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Awrite(aid, H5T_STD_REF_DSETREG, ref) < 0) {
        TEST_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t create_reg_ref_dataset(hid_t file_id, hid_t loc_id)
{
    ...
    if ((dsetr_id = H5Dcreate2(loc_id, dsetnamer, H5T_STD_REF_DSETREG, spacer_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((dsetr_id = H5Dcreate2(loc_id, dsetnamer1, H5T_STD_REF_DSETREG, spacer_id, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Pclose(pid) < 0) {
        TEST_ERROR;
    ...
    if ((dsetr_id = H5Dcreate2(loc_id, dsetnamer2, H5T_STD_REF_DSETREG, spacer_id, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Pclose(pid) < 0) {
        TEST_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_attach_attribute_vl(hid_t loc_id)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_attach_attributes(hid_t loc_id, hid_t type_id)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_attach_paired_attributes(hid_t loc_id, hid_t loc_id2, hid_t type_id)
{
    hid_t aid = H5I_INVALID_HID, sid = H5I_INVALID_HID;
    char attr_name[ATTR_NAME_LEN];
    int attr_data[2];
 ...
 *-------------------------------------------------------------------------
 */
static int compare_attribute(hid_t aid, hid_t aid2, hid_t pid, const void* wbuf, hid_t obj_owner)
{
 ...
 *-------------------------------------------------------------------------
 */
static int compare_std_attributes(hid_t oid, hid_t oid2, hid_t pid)
{
    ...
    if (cpy_flags & H5O_COPY_WITHOUT_ATTR_FLAG) {
        ...
        for (i = 0; i < (unsigned)oinfo1.num_attrs; i++) {
            if ((aid = H5Aopen_by_idx(oid, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, (hsize_t)i, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
                TEST_ERROR;
            }
...
static int compare_data(hid_t parent1, hid_t parent2, hid_t pid, hid_t tid, size_t nelmts, const void* buf1, const void* buf2, hid_t obj_owner)
{
    ...
    if ((H5Tget_class(tid) == H5T_COMPOUND) && (H5Tdetect_class(tid, H5T_VLEN) == true)) {
        ...
        for (memb_idx = 0; memb_idx < (unsigned)nmembs; memb_idx++) {
            ...
            if (H5Tget_class(memb_id) == H5T_VLEN) {
                ...
                for (elmt = 0; elmt < nelmts; elmt++) {
                    /* Check vlen lengths */
                    if (((const hvl_t*)((const void*)memb1))->len != ((const hvl_t*)((const void*)memb2))->len) {
                        TEST_ERROR;
                    }

                    /* Check vlen data */
                    if (!compare_data(parent1,
                                      parent2,
                                      pid,
                                      base_id,
                                      ((const hvl_t*)((const void*)memb1))->len,
                                      ((const hvl_t*)((const void*)memb1))->p,
                                      ((const hvl_t*)((const void*)memb2))->p,
                                      obj_owner)) {
                        TEST_ERROR;
                    }
        ...
        for (u = 0; u < nelmts; u++, vl_buf1++, vl_buf2++) {
            ...
            /* Check vlen data */
            if (!compare_data(parent1, parent2, pid, base_tid, vl_buf1->len, vl_buf1->p, vl_buf2->p, obj_owner)) {
                TEST_ERROR;
            }
        } /* end for */
...
static int compare_datasets(hid_t did, hid_t did2, hid_t pid, const void* wbuf)
{
     ...
     *  size will thus vary)
     */
    if (!(nfilters > 0 && (H5Tdetect_class(tid, H5T_VLEN) || (H5Tdetect_class(tid, H5T_REFERENCE) && H5Tequal(tid, H5T_STD_REF_DSETREG))))) {
...
static int compare_groups(hid_t gid, hid_t gid2, hid_t pid, int depth, unsigned copy_flags)
{
    ...
    if (ginfo2.nlinks > 0) {
        ...
        for (idx = 0; idx < ginfo.nlinks; idx++) {
            ...
            if (H5Lget_name_by_idx(gid, ".", H5_INDEX_NAME, H5_ITER_INC, idx, objname, (size_t)NAME_BUF_SIZE, H5P_DEFAULT) < 0) {
                TEST_ERROR;
            }
            if (H5Lget_name_by_idx(gid2, ".", H5_INDEX_NAME, H5_ITER_INC, idx, objname2, (size_t)NAME_BUF_SIZE, H5P_DEFAULT) < 0) {
                TEST_ERROR;
            }
            ...
            if (linfo.type == H5L_TYPE_HARD) {
                ...
                /* Compare link values */
                if (linfo.type == H5L_TYPE_SOFT || (linfo.type >= H5L_TYPE_UD_MIN && linfo.type <= H5L_TYPE_MAX)) {
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_named_datatype(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_named_datatype_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype IDs */
    char src_filename[NAME_BUF_SIZE];
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_named_datatype_vl_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype IDs */
    char src_filename[NAME_BUF_SIZE];
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_named_datatype_attr_self(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_simple(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_versionbounds(hid_t fcpl_src, hid_t fapl_src)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_simple_samefile(hid_t fcpl, hid_t fapl)
{
    ...
    /* create 2D int dataset at SRC file */
    if ((did = H5Dcreate2(fid, NAME_DATASET_SIMPLE, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_simple_empty(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID, did2 = H5I_INVALID_HID;        /* Dataset IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compound(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_COMPOUND, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_chunked(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED_SINGLE, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED2, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED3, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED2_SINGLE, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED3_SINGLE, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED4_SINGLE, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if (H5Ocopy(fid_src, NAME_DATASET_CHUNKED_SINGLE, fid_dst, NAME_DATASET_CHUNKED_SINGLE, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    if (H5Ocopy(fid_src, NAME_DATASET_CHUNKED2_SINGLE, fid_dst, NAME_DATASET_CHUNKED2_SINGLE, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    if (H5Ocopy(fid_src, NAME_DATASET_CHUNKED3_SINGLE, fid_dst, NAME_DATASET_CHUNKED3_SINGLE, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    if (H5Ocopy(fid_src, NAME_DATASET_CHUNKED4_SINGLE, fid_dst, NAME_DATASET_CHUNKED4_SINGLE, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_chunked_empty(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t pid = H5I_INVALID_HID;                                /* Dataset creation property list ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_chunked_sparse(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t pid = H5I_INVALID_HID;                                /* Dataset creation property list ID */
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED4, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compressed(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_no_edge_filt(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
#ifdef H5_HAVE_FILTER_DEFLATE
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compact(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t pid = H5I_INVALID_HID;                                /* Dataset creation property list ID */
    ...
    /* create dataset */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_COMPACT, H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_external(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t pid = H5I_INVALID_HID;                                /* Dataset creation property list ID */
    ...
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_EXTERNAL, H5T_NATIVE_INT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_named_dtype(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    ...
    /* create dataset at SRC file */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_NAMED_DTYPE, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* copy the dataset from SRC to DST */
    if (H5Ocopy(fid_src, NAME_DATASET_NAMED_DTYPE, fid_dst, NAME_DATASET_NAMED_DTYPE, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_named_dtype_hier(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    ...
    if ((did = H5Dcreate2(gid, NAME_DATASET_NAMED_DTYPE, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if ((did = H5Dcreate2(gid, NAME_DATASET_NAMED_DTYPE2, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_named_dtype_hier_outside(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_multi_ohdr_chunks(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID, did2 = H5I_INVALID_HID;        /* Dataset IDs */
    ...
    /* create first dataset at SRC file */
    if ((did = H5Dcreate2(gid, NAME_DATASET_MULTI_OHDR, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create second dataset at SRC file */
    if ((did2 = H5Dcreate2(gid, NAME_DATASET_MULTI_OHDR2, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_attr_named_dtype(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    ...
    /* create second dataset at SRC file */
    if ((did2 = H5Dcreate2(gid, NAME_DATASET_MULTI_OHDR2, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_contig_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_chunked_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compact_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_attribute_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID, did2 = H5I_INVALID_HID;        /* Dataset IDs */
    ...
    if ((aid = H5Aopen_by_idx(did, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, (hsize_t)0, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if ((aid2 = H5Aopen_by_idx(did2, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, (hsize_t)0, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compressed_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
#ifdef H5_HAVE_FILTER_DEFLATE
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_group_empty(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t gid = H5I_INVALID_HID, gid2 = H5I_INVALID_HID;        /* Group IDs */
    char src_filename[NAME_BUF_SIZE];
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_root_group(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID;                                /* Dataset ID */
    ...
    if ((did = H5Dcreate2(fid_src, NAME_GROUP_DATASET, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
        TEST_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_group(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID;                                /* Dataset ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_group_deep(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID;                                /* Dataset ID */
    ...
    for (i = 0; i < NUM_SUB_GROUPS; i++) {
        ...
        for (j = 0; j < NUM_SUB_GROUPS; j++) {
            ...
            for (k = 0; k < NUM_DATASETS; k++) {
                ...
                /* add a dataset to the group */
                if ((did = H5Dcreate2(gid_sub2, objname, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
                    TEST_ERROR;
                }
                if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
                    TEST_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_group_loop(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID;  /* File IDs */
    hid_t gid = H5I_INVALID_HID, gid2 = H5I_INVALID_HID;         /* Group IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_group_wide_loop(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID;  /* File IDs */
    hid_t gid = H5I_INVALID_HID, gid2 = H5I_INVALID_HID;         /* Group IDs */
    hid_t gid_sub = H5I_INVALID_HID, gid_sub2 = H5I_INVALID_HID; /* Sub-group IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_group_links(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    ...
    /* add a dataset to the group */
    if ((did = H5Dcreate2(fid_src, NAME_LINK_DATASET, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
        TEST_ERROR;
    ...
    if ((did = H5Dcreate2(fid_ext, NAME_DATASET_SIMPLE, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
        TEST_ERROR;
    ...
    if (H5Lcreate_hard(fid_src, NAME_LINK_DATASET, H5L_SAME_LOC, NAME_LINK_HARD, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        FAIL_STACK_ERROR;
    }
    ...
    if (H5Lcreate_external(ext_filename, NAME_DATASET_SIMPLE, fid_src, NAME_LINK_EXTERN, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        FAIL_STACK_ERROR;
    }
    ...
    if (H5Lcreate_external("no_file", "no_object", fid_src, NAME_LINK_EXTERN_DANGLE2, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        FAIL_STACK_ERROR;
    }
    ...
    for (expand_soft = 0; expand_soft <= 1; expand_soft++) {
        for (expand_ext = 0; expand_ext <= 1; expand_ext++) {
            ...
            if (expand_ext) {
                ...
                if (H5Lcreate_external(ext_filename, NAME_DATASET_SIMPLE, fid_dst, NAME_LINK_EXTERN, H5P_DEFAULT, H5P_DEFAULT) < 0) {
                    TEST_ERROR;
                }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_soft_link(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID, did2 = H5I_INVALID_HID;        /* Dataset IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_ext_link(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID, fid_ext = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                                           /* Dataspace ID */
    hid_t did = H5I_INVALID_HID, did2 = H5I_INVALID_HID;                                   /* Dataset IDs */
    ...
    if (H5Lcreate_external(src_filename, NAME_LINK_DATASET, fid_ext, NAME_LINK_EXTERN, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_exist(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_path(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t did = H5I_INVALID_HID, did2 = H5I_INVALID_HID;        /* Dataset IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_same_file_named_datatype(hid_t fcpl_src, hid_t fapl)
{
    hid_t fid = H5I_INVALID_HID;                         /* File ID */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID; /* Datatype IDs */
    char filename[NAME_BUF_SIZE];
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_old_layout(hid_t fcpl_dst, hid_t fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID;         /* File IDs */
    hid_t did = H5I_INVALID_HID, did2 = H5I_INVALID_HID;                /* Dataset IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compact_named_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_contig_named_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid_copy = H5I_INVALID_HID;    /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_chunked_named_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid_copy = H5I_INVALID_HID;    /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compressed_named_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid_copy = H5I_INVALID_HID;    /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compact_vl_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_contig_vl_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_chunked_vl_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compressed_vl_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool test_open)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_contig_cmpd_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    ...
    /* create dataset at SRC file */
    if ((did = H5Dcreate2(fid_src, NAME_DATASET_CMPD_VL, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_chunked_cmpd_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_compact_cmpd_vl(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID, tid2 = H5I_INVALID_HID;        /* Datatype IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_null_ref(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    ...
    if ((did1 = H5Dcreate2(fid1, "obj_ref_dset", H5T_STD_REF_OBJ, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }

    /* Create region reference dataset at SRC file */
    if ((did2 = H5Dcreate2(fid1, "reg_ref_dset", H5T_STD_REF_DSETREG, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_null_ref_open(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    ...
    /* Create region reference dataset at SRC file */
    if ((did2 = H5Dcreate2(fid1, "reg_ref_dset", H5T_STD_REF_DSETREG, sid, H5P_DEFAULT, dcpl, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_attr_crt_order(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID; /* File IDs */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_committed_datatype_merge(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    ...
    /* create dataset at SRC file */
    if ((did = H5Dcreate2(fid_src1, NAME_DATASET_SIMPLE, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* create dataset at SRC file */
    if ((did = H5Dcreate2(fid_src2, NAME_DATASET_SIMPLE, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_committed_datatype_merge_same_file(hid_t fcpl, hid_t fapl, bool reopen)
{
    hid_t fid = H5I_INVALID_HID;       /* File ID */
    hid_t tid = H5I_INVALID_HID;       /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;       /* Dataspace ID */
    ...
    /* committed datatype */
    if ((H5Tcommit2(fid, NAME_GROUP_TOP "/" NAME_DATATYPE_SIMPLE, tid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }

    /* create dataset */
    if ((did = H5Dcreate2(fid, NAME_GROUP_TOP "/" NAME_DATASET_SIMPLE, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* committed datatype */
    if ((H5Tcommit2(fid, NAME_GROUP_TOP2 "/" NAME_DATATYPE_SIMPLE, tid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }

    /* create dataset */
    if ((did = H5Dcreate2(fid, NAME_GROUP_TOP2 "/" NAME_DATASET_SIMPLE, tid, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    /* copy SRC1 to DST */
    if (H5Ocopy(fid, NAME_GROUP_TOP "/" NAME_DATASET_SIMPLE, fid, NAME_GROUP_TOP4 "/" NAME_DATASET_SIMPLE, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }

    /* copy SRC2 to DST */
    if (H5Ocopy(fid, NAME_GROUP_TOP2 "/" NAME_DATASET_SIMPLE, fid, NAME_GROUP_TOP4 "/" NAME_DATASET_SIMPLE2, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_committed_dt_merge_attr(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_cdt_hier_merge(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
     ...
     */
    if (H5Ocopy(fid_src, NAME_GROUP_TOP "/" SRC_DSET1, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_DSET1, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    if (H5Ocopy(fid_src, NAME_GROUP_TOP "/" SRC_NDT_DSET2, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_DSET2, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    if (H5Ocopy(fid_src, NAME_GROUP_TOP "/" SRC_NDT_DSET3, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_DSET3, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }

    /* Open attribute with anon ndt (short), get token */
    if ((aid = H5Aopen_by_name(fid_dst, NAME_GROUP_UNCOPIED, DST_ATTR_ANON_SHORT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if ((tid = H5Aget_type(aid)) < 0) {
        TEST_ERROR;
    ...
    if ((aid = H5Aopen_by_name(fid_dst, NAME_GROUP_UNCOPIED, DST_ATTR_ANON_INT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if ((tid = H5Aget_type(aid)) < 0) {
        TEST_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_cdt_merge_cdt(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    ...
    if ((aid = H5Aopen_by_name(fid_dst, "/" SRC_ROOT_GROUP "/" SRC_NDT_DOUBLE, DST_ATTR, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if ((tid = H5Aget_type(aid)) < 0) {
        TEST_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_cdt_merge_suggs(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t ocpypl_id = H5I_INVALID_HID;                          /* Object copy plist ID */
    ...
    if (H5Ocopy(fid_src, SRC_NDT_INT, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_INT, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    ...
    if (H5Ocopy(fid_src, SRC_NDT_INT, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_INT, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    ...
    if (H5Ocopy(fid_src, SRC_NDT_INT, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_INT2, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_cdt_merge_dset_suggs(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    ...
    if (H5Ocopy(fid_src, SRC_NDT_DSET, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_DSET, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    ...
    /* copy "src_ndt_dset" from SRC file to "/uncopied/src_ndt_dset" at DST file */
    /* use default ocpypl_id -- without merging and suggestion */
    if (H5Ocopy(fid_src, SRC_NDT_DSET, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_DSET, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    ...
    if (H5Ocopy(fid_src, SRC_NDT_DSET, fid_dst, NAME_GROUP_UNCOPIED "/" SRC_NDT_DSET2, ocpypl_id, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_cdt_merge_all_suggs(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t gid = H5I_INVALID_HID;                                /* Group ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
...
static H5O_mcdt_search_ret_t mcdt_search_cb(void* _udata)
{
...
static int test_copy_set_mcdt_search_cb(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
...
static H5O_mcdt_search_ret_t mcdt_search_cbA(void* _udata)
{
...
static H5O_mcdt_search_ret_t mcdt_search_cbB(void* _udata)
{
    H5O_mcdt_search_ret_t* action = (H5O_mcdt_search_ret_t*)_udata;
...
static int test_copy_set_get_mcdt_search_cb(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, bool reopen)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
 ...
 *-------------------------------------------------------------------------
 */
static herr_t test_copy_iterate_cb(hid_t loc_id, const char* name, const H5L_info2_t H5_ATTR_UNUSED* link_info, void* op_data)
{
 ...
 */
static int test_copy_cdt_v1_header_bug(hid_t fcpl_src, hid_t src_fapl)
{
...
static int test_copy_iterate(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid1 = H5I_INVALID_HID, fid2 = H5I_INVALID_HID; /* File IDs */
    hid_t gid = H5I_INVALID_HID;                          /* Group ID */
    int i;
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_option(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl, unsigned flag, bool crt_intermediate_grp, const char* test_desciption)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID, fid_ext = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                                           /* Dataspace ID */
    hid_t did = H5I_INVALID_HID;                                                           /* Dataset ID */
    ...
    if ((did = H5Dcreate2(gid, NAME_DATASET_SIMPLE, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
        TEST_ERROR;
    ...
    if ((did = H5Dcreate2(gid_sub, NAME_DATASET_SIMPLE, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
        TEST_ERROR;
    ...
    if ((did = H5Dcreate2(gid_sub_sub, NAME_DATASET_SIMPLE, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
        TEST_ERROR;
    ...
    if ((flag & H5O_COPY_EXPAND_SOFT_LINK_FLAG) > 0) {
        ...
        if (H5Lcreate_hard(fid_src, NAME_DATASET_SUB_SUB, H5L_SAME_LOC, NAME_LINK_SOFT2, H5P_DEFAULT, H5P_DEFAULT) < 0) {
            FAIL_STACK_ERROR;
        }
        if (H5Lcreate_soft("nowhere", fid_src, NAME_LINK_SOFT_DANGLE2, H5P_DEFAULT, H5P_DEFAULT) < 0) {
            FAIL_STACK_ERROR;
    ...
    if ((flag & H5O_COPY_EXPAND_EXT_LINK_FLAG) > 0) {
        ...
        if (H5Lcreate_external("no_file", "no_object", fid_src, NAME_LINK_EXTERN_DANGLE, H5P_DEFAULT, H5P_DEFAULT) < 0) {
            TEST_ERROR;
        }
        if (H5Gclose(gid) < 0) {
            TEST_ERROR;
        ...
        if ((did = H5Dcreate2(fid_src, NAME_LINK_EXTERN2, H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
            TEST_ERROR;
        }
        if (H5Dwrite(did, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf) < 0) {
            TEST_ERROR;
 ...
 *-------------------------------------------------------------------------
 */
static int test_copy_dataset_open(hid_t fcpl_src, hid_t fcpl_dst, hid_t src_fapl, hid_t dst_fapl)
{
    hid_t fid_src = H5I_INVALID_HID, fid_dst = H5I_INVALID_HID; /* File IDs */
    hid_t sid = H5I_INVALID_HID;                                /* Dataspace ID */
    hid_t tid = H5I_INVALID_HID;                                /* Datatype ID */
    ...
    if ((did2 = H5Dcreate2(fid_src, NAME_DATASET_CHUNKED, H5T_NATIVE_INT, sid, H5P_DEFAULT, pid, H5P_DEFAULT)) < 0) {
        TEST_ERROR;
    }
    ...
    if (H5Ocopy(fid_src, NAME_DATASET_NAMED_DTYPE, fid_src, NAME_DATASET_NAMED_DTYPE2, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
    ...
    if (H5Ocopy(fid_src, NAME_DATASET_NAMED_DTYPE, fid_dst, NAME_DATASET_NAMED_DTYPE2, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        TEST_ERROR;
    }
...
int main(void)
{
    ...
    for (configuration = 0; configuration <= MAX_CONFIGURATION; configuration++) {
        ...
        nerrors += test_copy_option(fcpl_src, fcpl_dst, src_fapl, dst_fapl, H5O_COPY_WITHOUT_ATTR_FLAG, false, "H5Ocopy(): without attributes");
        nerrors += test_copy_option(fcpl_src, fcpl_dst, src_fapl, dst_fapl, 0, true, "H5Ocopy(): with missing groups");
        nerrors += test_copy_option(fcpl_src, fcpl_dst, src_fapl, dst_fapl, H5O_COPY_EXPAND_SOFT_LINK_FLAG, false, "H5Ocopy(): expand soft link");
        nerrors += test_copy_option(fcpl_src, fcpl_dst, src_fapl, dst_fapl, H5O_COPY_EXPAND_EXT_LINK_FLAG, false, "H5Ocopy(): expand external link");

        /* Splitter VFD currently has external link-related bugs */
        if (strcmp(driver_name, "splitter")) {
            nerrors += test_copy_option(fcpl_src,
                                        fcpl_dst,
                                        src_fapl,
                                        dst_fapl,
        ...
        nerrors += test_copy_option(fcpl_src, fcpl_dst, src_fapl, dst_fapl, H5O_COPY_SHALLOW_HIERARCHY_FLAG, false, "H5Ocopy(): shallow group copy");
        nerrors += test_copy_option(fcpl_src, fcpl_dst, src_fapl, dst_fapl, H5O_COPY_EXPAND_REFERENCE_FLAG, false, "H5Ocopy(): expand object reference");
        nerrors += test_copy_option(fcpl_src, fcpl_dst, src_fapl, dst_fapl, H5O_COPY_PRESERVE_NULL_FLAG, false, "H5Ocopy(): preserve NULL messages");
        nerrors += test_copy_option(fcpl_src,
                                    fcpl_dst,
                                    src_fapl,
                                    dst_fapl,
