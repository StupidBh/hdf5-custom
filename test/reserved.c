 ...
 *-------------------------------------------------------------------------
 */
static herr_t rsrv_vlen(void)
{
    hid_t file_id = (H5I_INVALID_HID), dataset_id = (H5I_INVALID_HID), dataspace_id = (H5I_INVALID_HID), type_id = (H5I_INVALID_HID);
...
int main(void)
{
    ...
    if (strcmp(driver_name, "core") && strcmp(driver_name, "split") && strcmp(driver_name, "multi") && strcmp(driver_name, "family")) {
        num_errs += rsrv_ohdr();
        num_errs += rsrv_heap();
        num_errs += rsrv_vlen();
