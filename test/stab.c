 ...
 *-------------------------------------------------------------------------
 */
static int test_misc(hid_t fcpl, hid_t fapl, bool new_format)
{
 ...
 *-------------------------------------------------------------------------
 */
static int test_long(hid_t fcpl, hid_t fapl, bool new_format)
{
    hid_t fid = (H5I_INVALID_HID); /* File ID */
 ...
 *-------------------------------------------------------------------------
 */
static int test_large(hid_t fcpl, hid_t fapl, bool new_format)
{
    hid_t fid = (H5I_INVALID_HID);                          /* File ID */
 ...
 *-------------------------------------------------------------------------
 */
static int lifecycle(hid_t fcpl, hid_t fapl2)
{
    hid_t fid = (H5I_INVALID_HID);  /* File ID */
 ...
 *-------------------------------------------------------------------------
 */
static int long_compact(hid_t fcpl, hid_t fapl2)
{
    hid_t fid = (H5I_INVALID_HID);  /* File ID */
    hid_t gid = (H5I_INVALID_HID);  /* Group ID */
 ...
 *-------------------------------------------------------------------------
 */
static int no_compact(hid_t fcpl, hid_t fapl2)
{
    hid_t fid = (H5I_INVALID_HID);  /* File ID */
    hid_t gid = (H5I_INVALID_HID);  /* Group ID */
    hid_t gid2 = (H5I_INVALID_HID); /* Datatype ID */
 ...
 *-------------------------------------------------------------------------
 */
static int gcpl_on_root(hid_t fapl2)
{
    hid_t fid = (H5I_INVALID_HID);  /* File ID */
    hid_t gid = (H5I_INVALID_HID);  /* Group ID */
    hid_t gid2 = (H5I_INVALID_HID); /* Datatype ID */
 ...
 *-------------------------------------------------------------------------
 */
static int corrupt_stab_msg(void)
{
    hid_t fid = (H5I_INVALID_HID); /* File ID */
