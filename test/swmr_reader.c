...
static int check_dataset(hid_t fid, bool verbose, FILE* verbose_file, const char* sym_name, symbol_t* record, hid_t rec_sid);
static int read_records(const char* filename,
                        bool verbose,
                        FILE* verbose_file,
        ...
        if (record->rec_id != start[1]) {
            ...
            if (verbose) {
                ...
                fprintf(verbose_file,
                        ...
                        sym_name,
                        (long long)snpoints,
                        (unsigned long long)record->rec_id);
            } /* end if */
            return -1;
        } /* end if */
    } /* end if */
