...
#define CHECK(ret, val, where)                                      \
    do {                                                            \
        if (VERBOSE_HI) {                                           \
            printf(                                                 \
                "   Call to routine: %15s at line %4d "             \
                "in %s returned %ld \n",                            \
                where,                                              \
                (int)__LINE__,                                      \
                __FILE__,                                           \
        ...
        if ((ret) == (val)) {                                       \
            TestErrPrintf(                                          \
                "*** UNEXPECTED RETURN from %s is %ld at line %4d " \
                "in %s\n",                                          \
                where,                                              \
                (long)(ret),                                        \
                (int)__LINE__,                                      \
...
#define VERIFY(_x, _val, where)                                                       \
    do {                                                                              \
        ...
        if (VERBOSE_HI) {                                                             \
            printf(                                                                   \
                "   Call to routine: %15s at line %4d in %s had value "               \
                "%ld \n",                                                             \
                (where),                                                              \
                (int)__LINE__,                                                        \
                __FILE__,                                                             \
        ...
        if ((__x) != (__val)) {                                                       \
            TestErrPrintf(                                                            \
                "*** UNEXPECTED VALUE from %s should be %ld, but is %ld at line %4d " \
                "in %s\n",                                                            \
                (where),                                                              \
                __val,                                                                \
                __x,                                                                  \
...
#define VERIFY_STR(x, val, where)                                                   \
    do {                                                                            \
        ...
        if (strcmp(x, val) != 0) {                                                  \
            TestErrPrintf(                                                          \
                "*** UNEXPECTED VALUE from %s should be %s, but is %s at line %4d " \
                "in %s\n",                                                          \
                where,                                                              \
                val,                                                                \
                x,                                                                  \
...
#define RESULT(ret, func)                                              \
    do {                                                               \
        if (VERBOSE_MED) {                                             \
            printf(                                                    \
                "   Call to routine: %15s at line %4d in %s returned " \
                "%ld\n",                                               \
                func,                                                  \
                (int)__LINE__,                                         \
                __FILE__,                                              \
