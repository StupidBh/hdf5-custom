 ...
 *-------------------------------------------------------------------------
 */
static herr_t test_time_formatting(void)
{
    char* s = NULL;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t test_timer_system_user(void)
{
    int i;
    char* buf = NULL;
    H5_timer_t timer;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t test_timer_elapsed(void)
{
    int i;
    char* buf = NULL;
    H5_timer_t timer;
...
static herr_t test_timer_functionality(void)
{
    int i;
    char* buf = NULL;
    H5_timer_t timer;
