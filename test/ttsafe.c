...
H5_ATTR_PURE static unsigned num_digits(int num)
{
    unsigned u;
...
void tts_is_threadsafe(void H5_ATTR_UNUSED* params)
{
    bool is_ts;
    bool should_be;
...
int main(int argc, char* argv[])
{
    ...
    /* Recursive R/W locks */
    AddTest("rec_rwlock_1", tts_rec_rwlock_smoke_check_1, NULL, NULL, NULL, 0, "recursive R/W lock smoke check 1 -- basic");
    AddTest("rec_rwlock_2", tts_rec_rwlock_smoke_check_2, NULL, NULL, NULL, 0, "recursive R/W lock smoke check 2 -- mob of readers");
    AddTest("rec_rwlock_3", tts_rec_rwlock_smoke_check_3, NULL, NULL, NULL, 0, "recursive R/W lock smoke check 3 -- mob of writers");
    AddTest("rec_rwlock_4", tts_rec_rwlock_smoke_check_4, NULL, NULL, NULL, 0, "recursive R/W lock smoke check 4 -- mixed mob");
