...
#define WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_CH_NROWS     (WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NROWS / mpi_size)
#define WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_CH_NCOLS     (WRITE_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NCOLS / mpi_size)
...
#define READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_CH_NROWS     (READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NROWS / mpi_size)
#define READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_CH_NCOLS     (READ_UNSHARED_TRANSFORMED_FILTERED_CHUNKS_NCOLS / mpi_size)
...
#define WRITE_UNSHARED_FILTERED_EDGE_CHUNKS_NCOLS         (mpi_size * DIM1_SCALE_FACTOR) + (WRITE_UNSHARED_FILTERED_EDGE_CHUNKS_CH_NCOLS - 1)
...
#define WRITE_SHARED_FILTERED_EDGE_CHUNKS_NROWS         (WRITE_SHARED_FILTERED_EDGE_CHUNKS_CH_NROWS * DIM0_SCALE_FACTOR)
#define WRITE_SHARED_FILTERED_EDGE_CHUNKS_NCOLS ((WRITE_SHARED_FILTERED_EDGE_CHUNKS_CH_NCOLS * DIM1_SCALE_FACTOR) + (WRITE_SHARED_FILTERED_EDGE_CHUNKS_CH_NCOLS - 1))
