...
{
    fprintf(rawerrorstream, "Warning: dataset <%s> cannot be read, %s filter is not available\n", dname, fname);
}
                     ...
                     hid_t dcpl_id)    /* dataset creation property list */
{
    ...
    for (i = 0; i < nfilters; i++) {
        ...
        case H5Z_FILTER_NBIT:
             ...
             *-------------------------------------------------------------------------
             */
        case H5Z_FILTER_SCALEOFFSET: break;
        } /*switch*/
    } /*for*/
 ...
 *-------------------------------------------------------------------------
 */
H5_ATTR_CONST int h5tools_can_encode(H5Z_filter_t filtn)
{
    int ret_value = 1;

    switch (filtn) {
    /* user defined filter     */
    default: H5TOOLS_GOTO_DONE(0); break;
    case H5Z_FILTER_DEFLATE:
#ifndef H5_HAVE_FILTER_DEFLATE
        H5TOOLS_GOTO_DONE(0);
#endif
    ...
    case H5Z_FILTER_SHUFFLE: break;

    case H5Z_FILTER_FLETCHER32: break;

    case H5Z_FILTER_NBIT: break;
