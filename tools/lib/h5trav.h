...
typedef herr_t (*h5trav_obj_func_t)(const char* path_name, const H5O_info2_t* oinfo, bool already_visited, const trav_seen_t* visited_obj_info, void* udata);
...
extern "C"
{
    ...
    H5TOOLS_DLL bool symlink_is_visited(symlink_trav_t* visited, H5L_type_t type, const char* file, const char* path);
    ...
    H5TOOLS_DLL int trav_info_visit_obj(const char* path, const H5O_info2_t* oinfo, bool already_visited, const trav_seen_t* visited_obj_info, void* udata);
...
H5TOOLS_DLL void trav_table_addflags(const unsigned* flags, char* objname, h5trav_type_t type, trav_table_t* table);
