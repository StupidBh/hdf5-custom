 ...
 *-------------------------------------------------------------------------
 */
static void usage(const char* prog, const pack_opt_t* options)
{
...
static int parse_command_line(int argc, const char* const* argv, pack_opt_t* options)
{
    ...
    while (EOF != (opt = H5_get_option(argc, argv, s_opts, l_opts))) {
        ...
        case 'n': options->use_native = 1; break;
        ...
        case 'X': options->merge = true; break;

        case 'W': options->prune = true; break;
        ...
        case 'u': options->ublock_filename = H5_optarg; break;

        case 'b': options->ublock_size = (hsize_t)atol(H5_optarg); break;

        case 'M': options->meta_block_size = (hsize_t)atol(H5_optarg); break;

        case 't': options->threshold = (hsize_t)atol(H5_optarg); break;
        ...
        case '3': in_vol_info.info_string = H5_optarg; break;
        ...
        case '6': out_vol_info.info_string = H5_optarg; break;
        ...
        case '9': in_vfd_info.info = (const void*)H5_optarg; break;
        ...
        case 'Z': out_vfd_info.info = (const void*)H5_optarg; break;
