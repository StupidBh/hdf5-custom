...
static size_t myfilter(unsigned int H5_ATTR_UNUSED flags,
...
static size_t H5Z_filter_dynlibud(unsigned int flags, size_t cd_nelmts, const unsigned int* cd_values, size_t nbytes, size_t* buf_size, void** buf);
...
static float fp8_e4m3_vals[256] = {
    0.0f,      0.001953f,  0.003906f,  0.005859f,  0.007812f,  0.009766f,  0.01172f,  0.01367f,  0.01562f,  0.01758f,  0.01953f,  0.02148f,  0.02344f,
    0.02539f,  0.02734f,   0.0293f,    0.03125f,   0.03516f,   0.03906f,   0.04297f,  0.04688f,  0.05078f,  0.05469f,  0.05859f,  0.0625f,   0.07031f,
    0.07812f,  0.08594f,   0.09375f,   0.1016f,    0.1094f,    0.1172f,    0.125f,    0.1406f,   0.1562f,   0.1719f,   0.1875f,   0.2031f,   0.2188f,
    0.2344f,   0.25f,      0.2812f,    0.3125f,    0.3438f,    0.375f,     0.4062f,   0.4375f,   0.4688f,   0.5f,      0.5625f,   0.625f,    0.6875f,
    0.75f,     0.8125f,    0.875f,     0.9375f,    1.0f,       1.125f,     1.25f,     1.375f,    1.5f,      1.625f,    1.75f,     1.875f,    2.0f,
    2.25f,     2.5f,       2.75f,      3.0f,       3.25f,      3.5f,       3.75f,     4.0f,      4.5f,      5.0f,      5.5f,      6.0f,      6.5f,
    7.0f,      7.5f,       8.0f,       9.0f,       10.0f,      11.0f,      12.0f,     13.0f,     14.0f,     15.0f,     16.0f,     18.0f,     20.0f,
    22.0f,     24.0f,      26.0f,      28.0f,      30.0f,      32.0f,      36.0f,     40.0f,     44.0f,     48.0f,     52.0f,     56.0f,     60.0f,
    64.0f,     72.0f,      80.0f,      88.0f,      96.0f,      104.0f,     112.0f,    120.0f,    128.0f,    144.0f,    160.0f,    176.0f,    192.0f,
    208.0f,    224.0f,     240.0f,     256.0f,     288.0f,     320.0f,     352.0f,    384.0f,    416.0f,    448.0f,    0.0f, /* 1 NaN value, ignore with 0.0f */
    -0.0f,     -0.001953f, -0.003906f, -0.005859f, -0.007812f, -0.009766f, -0.01172f, -0.01367f, -0.01562f, -0.01758f, -0.01953f, -0.02148f, -0.02344f,
    -0.02539f, -0.02734f,  -0.0293f,   -0.03125f,  -0.03516f,  -0.03906f,  -0.04297f, -0.04688f, -0.05078f, -0.05469f, -0.05859f, -0.0625f,  -0.07031f,
    -0.07812f, -0.08594f,  -0.09375f,  -0.1016f,   -0.1094f,   -0.1172f,   -0.125f,   -0.1406f,  -0.1562f,  -0.1719f,  -0.1875f,  -0.2031f,  -0.2188f,
    -0.2344f,  -0.25f,     -0.2812f,   -0.3125f,   -0.3438f,   -0.375f,    -0.4062f,  -0.4375f,  -0.4688f,  -0.5f,     -0.5625f,  -0.625f,   -0.6875f,
...
static float fp8_e5m2_vals[256] = {
    0.0f,        0.0000153f,  0.0000305f,  0.0000458f,  0.000061f,   0.0000763f,  0.0000916f,  0.0001068f,  0.0001221f,  0.0001526f,  0.0001831f,  0.0002136f,
    0.0002441f,  0.0003052f,  0.0003662f,  0.0004272f,  0.0004883f,  0.0006104f,  0.0007324f,  0.0008545f,  0.0009766f,  0.001221f,   0.001465f,   0.001709f,
    0.001953f,   0.002441f,   0.00293f,    0.003418f,   0.003906f,   0.004883f,   0.005859f,   0.006836f,   0.007812f,   0.009766f,   0.01172f,    0.01367f,
    0.01562f,    0.01953f,    0.02344f,    0.02734f,    0.03125f,    0.03906f,    0.04688f,    0.05469f,    0.0625f,     0.07812f,    0.09375f,    0.1094f,
    0.125f,      0.1562f,     0.1875f,     0.2188f,     0.25f,       0.3125f,     0.375f,      0.4375f,     0.5f,        0.625f,      0.75f,       0.875f,
    1.0f,        1.25f,       1.5f,        1.75f,       2.0f,        2.5f,        3.0f,        3.5f,        4.0f,        5.0f,        6.0f,        7.0f,
    8.0f,        10.0f,       12.0f,       14.0f,       16.0f,       20.0f,       24.0f,       28.0f,       32.0f,       40.0f,       48.0f,       56.0f,
    64.0f,       80.0f,       96.0f,       112.0f,      128.0f,      160.0f,      192.0f,      224.0f,      256.0f,      320.0f,      384.0f,      448.0f,
    512.0f,      640.0f,      768.0f,      896.0f,      1024.0f,     1280.0f,     1536.0f,     1792.0f,     2048.0f,     2560.0f,     3072.0f,     3584.0f,
    4096.0f,     5120.0f,     6144.0f,     7168.0f,     8192.0f,     10240.0f,    12288.0f,    14336.0f,    16384.0f,    20480.0f,    24576.0f,    28672.0f,
    32768.0f,    40960.0f,    49152.0f,    57344.0f,    INFINITY,    0.0f,        0.0f,        0.0f, /* 3 NaN values, ignore with 0.0f */
    -0.0f,       -0.0000153f, -0.0000305f, -0.0000458f, -0.000061f,  -0.0000763f, -0.0000916f, -0.0001068f, -0.0001221f, -0.0001526f, -0.0001831f, -0.0002136f,
    -0.0002441f, -0.0003052f, -0.0003662f, -0.0004272f, -0.0004883f, -0.0006104f, -0.0007324f, -0.0008545f, -0.0009766f, -0.001221f,  -0.001465f,  -0.001709f,
    -0.001953f,  -0.002441f,  -0.00293f,   -0.003418f,  -0.003906f,  -0.004883f,  -0.005859f,  -0.006836f,  -0.007812f,  -0.009766f,  -0.01172f,   -0.01367f,
    -0.01562f,   -0.01953f,   -0.02344f,   -0.02734f,   -0.03125f,   -0.03906f,   -0.04688f,   -0.05469f,   -0.0625f,    -0.07812f,   -0.09375f,   -0.1094f,
 ...
 * the datatypes are represented correctly.
 */
static float fp6_e2m3_vals[64] = { 0.0f,    0.125f, 0.25f,   0.375f, 0.5f,    0.625f, 0.75f,   0.875f,  1.0f,    1.125f,  1.25f,  1.375f,  1.5f,
                                   1.625f,  1.75f,  1.875f,  2.0f,   2.25f,   2.5f,   2.75f,   3.0f,    3.25f,   3.5f,    3.75f,  4.0f,    4.5f,
                                   5.0f,    5.5f,   6.0f,    6.5f,   7.0f,    7.5f,   -0.0f,   -0.125f, -0.25f,  -0.375f, -0.5f,  -0.625f, -0.75f,
                                   -0.875f, -1.0f,  -1.125f, -1.25f, -1.375f, -1.5f,  -1.625f, -1.75f,  -1.875f, -2.0f,   -2.25f, -2.5f,   -2.75f,
                                   -3.0f,   -3.25f, -3.5f,   -3.75f, -4.0f,   -4.5f,  -5.0f,   -5.5f,   -6.0f,   -6.5f,   -7.0f,  -7.5f };

static float fp6_e3m2_vals[64] = {
    0.0f,  0.0625f,  0.125f,  0.1875f,  0.25f,  0.3125f,  0.375f,  0.4375f,  0.5f,  0.625f,  0.75f,  0.875f,  1.0f,   1.25f,  1.5f,   1.75f,
    2.0f,  2.5f,     3.0f,    3.5f,     4.0f,   5.0f,     6.0f,    7.0f,     8.0f,  10.0f,   12.0f,  14.0f,   16.0f,  20.0f,  24.0f,  28.0f,
    -0.0f, -0.0625f, -0.125f, -0.1875f, -0.25f, -0.3125f, -0.375f, -0.4375f, -0.5f, -0.625f, -0.75f, -0.875f, -1.0f,  -1.25f, -1.5f,  -1.75f,
    -2.0f, -2.5f,    -3.0f,   -3.5f,    -4.0f,  -5.0f,    -6.0f,   -7.0f,    -8.0f, -10.0f,  -12.0f, -14.0f,  -16.0f, -20.0f, -24.0f, -28.0f,
};
 ...
 * the datatypes are represented correctly.
 */
static float fp4_e2m1_vals[16] = { 0.0f, 0.5f, 1.0f, 1.5f, 2.0f, 3.0f, 4.0f, 6.0f, -0.0f, -0.5f, -1.0f, -1.5f, -2.0f, -3.0f, -4.0f, -6.0f };
...
void gent_many(void)
{
    ...
    typedef struct
    {                      /* compound type has members with rank > 1 */
...
void gent_str(void)
{
    ...
    hsize_t dims2[] = { 20 };
    char string2[20][10] = { "ab cd ef1", "ab cd ef2", "ab cd ef3", "ab cd ef4", "ab cd ef5", "ab cd ef6", "ab cd ef7", "ab cd ef8", "ab cd ef9", "ab cd ef0",
                             "ab cd ef1", "ab cd ef2", "ab cd ef3", "ab cd ef4", "ab cd ef5", "ab cd ef6", "ab cd ef7", "ab cd ef8", "ab cd ef9", "ab cd ef0" };

    hsize_t dims3[] = { 27 };
    char string3[27][6] = { "abcd0", "abcd1", "abcd2", "abcd3", "abcd4", "abcd5", "abcd6", "abcd7", "abcd8", "abcd9", "abcd0", "abcd1", "abcd2", "abcd3",
                            "abcd4", "abcd5", "abcd6", "abcd7", "abcd8", "abcd9", "abcd0", "abcd1", "abcd2", "abcd3", "abcd4", "abcd5", "abcd6" };
...
void gent_enum(void)
{
    ...
    int val;
    enumtype data[] = { RED, GREEN, BLUE, GREEN, WHITE, WHITE, BLACK, GREEN, BLUE, RED, RED, BLUE, GREEN, BLACK, WHITE, RED, WHITE, GREEN, GREEN, BLUE };
...
{
    const char* wdata[SPACE1_DIM1] = { "Four score and seven years ago our forefathers brought forth on this continent a new nation,",
...
void gent_compound_complex(void)
{
    ...
    /* Create the dataset                                             */
    dataset = H5Dcreate2(datafile, F41_DATASETNAME, Array1Structid, dataspace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
...
void gent_zero_dim_size(void)
{
    ...
    /* dataset */
    dataset = H5Dcreate2(fid, "dset of 0 dimension size", H5T_STD_I32BE, space, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
    /* nothing should be written */
    H5Dwrite(dataset, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &dset_buf);
 ...
 *-------------------------------------------------------------------------
 */
static void make_external(hid_t fid)
{
...
static herr_t set_local_myfilter(hid_t dcpl_id, hid_t H5_ATTR_UNUSED tid, hid_t H5_ATTR_UNUSED sid)
{
...
void gent_string(void)
{
    ...
    const char* buf2[SPACE1_DIM1] = { "Four score and seven\n years ago our forefathers brought forth on this continent a new nation,",
        ...
        for (j = 0; j < F81_YDIM; j++) {
            for (k = 0; k < F81_XDIM; k++) {
                for (l = 0; l < F81_WDIM; l++) {
                    dset1->arr[i][j][k][l] = i * F81_YDIM * F81_XDIM * F81_WDIM + j * F81_XDIM * F81_WDIM + k * F81_WDIM + l;
                }
            }
        }
    }
...
void gent_vlenstr_array(void)
{
    ...
    const char* test[F83_ARRAYDIM] = { "This is a variable-length test string.",
...
static void onion_filepaths_destroy(struct onion_filepaths* s)
{
    if (s) {
        free(s->canon);
        free(s->onion);
...
int gent_onion_create_delete_objects(void)
{
    ...
    if ((attr_id = H5Acreate2(file, "file_attribute", H5T_STD_I32LE, attr_space_id, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        goto error;
    }
...
void gent_trefer_attr(void)
{
    ...
    dataset1_id = H5Dcreate2(group_id, "Dataset1", H5T_STD_U32LE, dataspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
    ...
    dataset2_id = H5Dcreate2(group_id, "Dataset2", H5T_STD_U8LE, dataspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
    ...
    dataset3_id = H5Dcreate2(file_id, "Dataset3", H5T_STD_REF, dataspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
...
void gent_tattr4_be(void)
{
    ...
    dataset_id = H5Dcreate2(file_id, "data", H5T_IEEE_F32BE, dataspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
...
void gent_tno_subset(void)
{
    ...
    dataset_id = H5Dcreate2(file_id, F101_DSET, H5T_STD_I32LE, dataspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
...
int gent_tvms(void)
{
    ...
    if ((dataset_id = H5Dcreate2(file_id, "/Array", H5T_VAX_F64, dataspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        return -1;
    }
