...
void gen_ext(const char* fname, unsigned new_format, unsigned what)
{
    ...
    switch (what) {
    case 0: H5Pset_istore_k(fcpl, ISTORE_IK); break;
    case 1: H5Pset_shared_mesg_nindexes(fcpl, 4); break;
    case 2: H5Pset_file_space_strategy(fcpl, H5F_FSPACE_STRATEGY_PAGE, false, (hsize_t)1); break;
    case 3:
