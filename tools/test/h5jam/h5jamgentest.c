...
herr_t gent_ub(const char* filename, size_t ub_size, size_t ub_fill)
{
    ...
    if ((dataset = H5Dcreate2(group, "dset1.1.1", H5T_STD_I32BE, space, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        goto error;
    }
    for (i = 0; i < 10; i++) {
        for (j = 0; j < 10; j++) {
    ...
    if ((dataset = H5Dcreate2(group, "dset1.1.2", H5T_STD_I32BE, space, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        goto error;
    }
    for (i = 0; i < 20; i++) {
        dset2[i] = i;
    ...
    if ((dataset = H5Dcreate2(group, "dset2.1", H5T_IEEE_F32BE, space, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        goto error;
    }
    for (i = 0; i < 10; i++) {
    ...
    if ((dataset = H5Dcreate2(group, "dset2.2", H5T_IEEE_F32BE, space, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
        goto error;
    }
    for (i = 0; i < 3; i++) {
        for (j = 0; j < 5; j++) {
    ...
    if (H5Lcreate_ud(fid, "/g2/udlink", (H5L_type_t)MY_LINKCLASS, NULL, (size_t)0, H5P_DEFAULT, H5P_DEFAULT) < 0) {
        goto error;
    }
