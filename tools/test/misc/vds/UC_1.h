...
static hsize_t UC_1_DIMS[UC_1_N_SOURCES][RANK] = { { 0, UC_1_SM_HEIGHT, UC_1_WIDTH }, { 0, UC_1_LG_HEIGHT, UC_1_WIDTH }, { 0, UC_1_SM_HEIGHT, UC_1_WIDTH },
...
static hsize_t UC_1_MAX_DIMS[UC_1_N_SOURCES][RANK] = { { UC_1_N_MAX_PLANES, UC_1_SM_HEIGHT, UC_1_WIDTH }, { UC_1_N_MAX_PLANES, UC_1_LG_HEIGHT, UC_1_WIDTH },
                                                       { UC_1_N_MAX_PLANES, UC_1_SM_HEIGHT, UC_1_WIDTH }, { UC_1_N_MAX_PLANES, UC_1_LG_HEIGHT, UC_1_WIDTH },
                                                       { UC_1_N_MAX_PLANES, UC_1_SM_HEIGHT, UC_1_WIDTH }, { UC_1_N_MAX_PLANES, UC_1_LG_HEIGHT, UC_1_WIDTH } };

/* File names for source datasets */
static char UC_1_FILE_NAMES[UC_1_N_SOURCES][NAME_LEN] = { { "1_a.h5" }, { "1_b.h5" }, { "1_c.h5" }, { "1_d.h5" }, { "1_e.h5" }, { "1_f.h5" } };
