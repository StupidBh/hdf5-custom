...
/* Planes */
static hsize_t UC_1_PLANES[UC_1_N_SOURCES][RANK] = { { 1, UC_1_SM_HEIGHT, UC_1_WIDTH }, { 1, UC_1_LG_HEIGHT, UC_1_WIDTH }, { 1, UC_1_SM_HEIGHT, UC_1_WIDTH },
...
int main(void)
{
    ...
    for (i = 0; i < UC_1_N_SOURCES; i++) {
        ...
        if ((did = H5Dcreate2(fid, UC_1_SOURCE_DSET_NAME, UC_1_SOURCE_DATATYPE, src_sid, H5P_DEFAULT, src_dcplid, H5P_DEFAULT)) < 0) {
            UC_ERROR
        }
    ...
    /* dataset */
    if ((did = H5Dcreate2(fid, UC_1_VDS_DSET_NAME, UC_1_VDS_DATATYPE, vds_sid, H5P_DEFAULT, vds_dcplid, H5P_DEFAULT)) < 0) {
        UC_ERROR
    }
